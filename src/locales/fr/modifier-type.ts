...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "Recevez {{modifierCount}} {{pokeballName}}s (Inventaire : {{pokeballAmount}}) \nTaux de capture : {{catchRate}}."
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "Restaure {{restorePoints}} PV ou {{restorePercent}}% des PV totaux d’un Pokémon, en fonction duquel des deux est le plus élevé",
      extra: {
        fully: "Restaure tous les PV d’un Pokémon.",
        fullyWithStatus:
          "Restaure tous les PV d’un Pokémon et soigne tous ses problèmes de statut."
      }
    },
    ...
    PokemonPpUpModifierType: {
      description:
        "Augmente le max de PP de {{upPoints}} à une capacité d’un Pokémon pour chaque 5 PP max (max : 3)."
    },
    PokemonNatureChangeModifierType: {
      name: "Aromate {{natureName}}",
      description:
        "Donne la nature {{natureName}} à un Pokémon et la débloque pour le starter lui étant lié."
    },
    DoubleBattleChanceBoosterModifierType: {
      description:
        "Double les chances de tomber sur un combat double pendant {{battleCount}} combats."
    },
    TempBattleStatBoosterModifierType: {
      description:
        "Augmente d’un cran {{tempBattleStatName}} pour toute l’équipe pendant 5 combats."
    },
    ...
    PokemonBaseStatBoosterModifierType: {
      description:
        "Augmente de 10% {{statName}} de base de son porteur. Plus les IV sont hauts, plus il peut en porter."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "Frappe une fois de plus en échange d’une baisse de puissance de respectivement 60/75/82,5% par cumul."
    },
    TmModifierType: {
    ...
    TmModifierTypeWithInfo: {
      name: "CT{{moveId}} - {{moveName}}",
      description:
        "Apprend la capacité {{moveName}} à un Pokémon\n(Hold C or Shift for more info)."
    },
    ...
    FusePokemonModifierType: {
      description:
        "Fusionne deux Pokémon (transfère le Talent, sépare les stats de base et les types, partage le movepool)."
    },
    ...
    ContactHeldItemTransferChanceModifierType: {
      description:
        "{{chancePercent}}% de chances de voler un objet de l’adversaire en l’attaquant."
    },
    ...
    EnemyAttackStatusEffectChanceModifierType: {
      description:
        "Ajoute {{chancePercent}}% de chances d’infliger le statut {{statusEffect}} avec des capacités offensives."
    },
    ...
    MAP: {
      name: "Carte",
      description: "Vous permet de choisir votre destination à un croisement."
    },
    ...
    REVIVER_SEED: {
      name: "Résugraine",
      description: "Réanime et restaure la moitié des PV de son porteur s’il tombe K.O."
    },
    ...
    MEMORY_MUSHROOM: {
      name: "Champi Mémoriel",
      description: "Remémore une capacité à un Pokémon."
    },

    EXP_SHARE: {
      name: "Multi Exp",
      description: "Tous les non-participants reçoivent 20% des Points d’Exp d’un participant."
    },
    EXP_BALANCE: {
      name: "Équilibr’Exp",
      description:
        "Équilibre les Points d’Exp à l’avantage des membres de l’équipe aux plus bas niveaux."
    },

    OVAL_CHARM: {
      name: "Charme Ovale",
      description:
        "Quand plusieurs Pokémon sont en combat, chacun gagne 10% supplémentaires du total d’Exp."
    },
    ...
    SOUL_DEW: {
      name: "Rosée Âme",
      description:
        "Augmente de 10% l’influence de la nature d’un Pokémon sur ses statistiques (cumulatif)."
    },
    ...
    GOLDEN_PUNCH: {
      name: "Poing Doré",
      description: "50% des dégâts infligés sont convertis en argent."
    },
    COIN_CASE: {
      name: "Boite Jetons",
      description: "Tous les 10 combats, recevez 10% de votre argent en intérêts."
    },

    LOCK_CAPSULE: {
      name: "Poké Écrin",
      description: "Permet de verrouiller des objets rares si vous relancez les objets proposés."
    },
    ...
    HEALING_CHARM: {
      name: "Charme Soin",
      description:
        "Augmente de 10% l’efficacité des capacités et objets de soin de PV (hors Rappels)."
    },
    CANDY_JAR: {
      name: "Bonbonnière",
      description: "Augmente de 1 le nombre de niveaux gagnés à l’utilisation d’un Super Bonbon."
    },

    BERRY_POUCH: {
      name: "Sac à Baies",
      description: "Ajoute 30% de chances qu’une Baie utilisée ne soit pas consommée."
    },

    FOCUS_BAND: {
      name: "Bandeau",
      description:
        "Ajoute 10% de chances de survivre avec 1 PV si les dégâts reçus pouvaient mettre K.O."
    },

    QUICK_CLAW: {
      name: "Vive Griffe",
      description:
        "Ajoute 10% de chances d’agir en premier, indépendamment de la vitesse (après la priorité)."
    },

    KINGS_ROCK: {
      name: "Roche Royale",
      description: "Ajoute 10% de chances qu’une capacité offensive apeure l’adversaire."
    },

    LEFTOVERS: {
      name: "Restes",
      description: "Soigne à chaque tour 1/16 des PV max d’un Pokémon."
    },
    SHELL_BELL: {
      name: "Grelot Coque",
      description: "Soigne 1/8 des dégâts infligés par un Pokémon."
    },

    TOXIC_ORB: {
      name: "Orbe Toxique",
      description: "Un orbe bizarre qui empoisonne gravement son porteur durant le combat."
    },
    FLAME_ORB: {
      name: "Orbe Flamme",
      description: "Un orbe bizarre qui brûle son porteur durant le combat."
    },

    BATON: {
      name: "Bâton",
      description:
        "Permet de transmettre les effets en cas de changement de Pokémon. Ignore les pièges."
    },

    SHINY_CHARM: {
      name: "Charme Chroma",
      description: "Augmente énormément les chances de rencontrer un Pokémon sauvage chromatique."
    },
    ABILITY_CHARM: {
      name: "Charme Talent",
      description:
        "Augmente énormément les chances de rencontrer un Pokémon sauvage avec un Talent Caché."
    },

    IV_SCANNER: {
      name: "Scanner d’IV",
      description:
        "Révèle la qualité de deux IV d’un Pokémon sauvage par scanner possédé. Les meilleurs IV sont révélés en priorité."
    },
    ...
    GOLDEN_POKEBALL: {
      name: "Poké Ball Dorée",
      description: "Ajoute un choix d’objet à la fin de chaque combat"
    },

    ENEMY_DAMAGE_BOOSTER: { name: "Jeton Dégâts", description: "Augmente les dégâts de 5%." },
    ENEMY_DAMAGE_REDUCTION: {
      name: "Jeton Protection",
      description: "Diminue les dégâts reçus de 2,5%."
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "Jeton Total Soin",
      description: "Ajoute 2.5% de chances à chaque tour de se soigner d’un problème de statut."
    },
    ENEMY_ENDURE_CHANCE: { name: "Jeton Ténacité" },
    ENEMY_FUSED_CHANCE: {
      name: "Jeton Fusion",
      description: "Ajoute 1% de chances qu’un Pokémon sauvage soit une fusion."
    }
  },
