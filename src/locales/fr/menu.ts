...
export const menu: SimpleTranslationEntries = {
  ...
  invalidRegisterUsername:
    "Le nom d’utilisateur ne doit contenir que\ndes lettres, chiffres ou traits bas",
  ...
  disclaimerDescription:
    "Ce jeu n’est pas un produit fini et peut contenir des problèmes de jouabilité, dont de possibles pertes de sauvegardes,\ndes modifications sans avertissement et pourrait ou non encore être mis à jour ou terminé."
} as const;
