...
export const move: MoveTranslationEntries = {
  ...
  lavaPlume: {
    name: "Ébullilave",
    effect:
      "Des flammes s’abattent sur tous les Pokémon autour du lanceur, ce qui peut aussi les brûler (10% de chances)."
  },
  leafStorm: {
    name: "Tempête Verte",
    effect:
  ...
  sludgeWave: {
    name: "Cradovague",
    effect:
      "Une vague de détritus attaque tous les Pokémon autour du lanceur. Peut aussi empoisonner (10% de chances)."
  },
  quiverDance: {
    name: "Papillodanse",
    effect:
  ...
  blueFlare: {
    name: "Flamme Bleue",
    effect:
      "De magnifiques et redoutables flammes bleues fondent sur l’ennemi. Peut aussi le brûler (20% de chances)."
  },
  fieryDance: {
    name: "Danse du Feu",
    effect:
  ...
  freezeShock: {
    name: "Éclair Gelé",
    effect:
      "Projette un bloc de glace électrifié sur l’ennemi au second tour. Peut aussi le paralyser (30% de chances)."
  },
  iceBurn: {
    name: "Feu Glacé",
    effect:
      "Au second tour, le lanceur projette un souffle de vent glacial dévastateur sur l’ennemi. Peut aussi le brûler (30% de chances)."
  },
  snarl: {
    name: "Aboiement",
  ...
  freezeDry: {
    name: "Lyophilisation",
    effect:
      "Le lanceur refroidit violemment la cible et peut la geler (10% de chances). Super efficace sur les Pokémon de type Eau."
  },
  disarmingVoice: {
    name: "Voix Enjôleuse",
    effect:
  ...
  steamEruption: {
    name: "Jet de Vapeur",
    effect:
      "Le lanceur projette de la vapeur extrêmement chaude sur la cible, ce qui peut aussi la brûler (30% de chances)."
  },
  hyperspaceHole: {
  ...
  breakneckBlitzPhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour s’élancer à toute vitesse sur l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  supersonicSkystrikePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour s’envoler très haut dans le ciel avant de plonger sur l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  acidDownpourPhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour répandre un marécage empoisonné où l’adversaire sombre. La puissance varie selon celle de la capacité originale."
  },
  acidDownpourSpecial: {
    name: "Déluge Causti-Toxique",
    effect: "Dummy Data"
  ...
  tectonicRagePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour entraîner l’adversaire dans les profondeurs de la terre. La puissance varie selon celle de la capacité originale."
  },
  tectonicRageSpecial: {
    name: "Éruption Géo-Sismique",
    effect: "Dummy Data"
  ...
  continentalCrushPhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour créer un immense rocher et écraser l’adversaire avec. La puissance varie selon celle de la capacité originale."
  },
  ...
  neverEndingNightmarePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour invoquer des esprits rancuniers qui s’abattent sur l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  corkscrewCrashPhysical: {
    name: "Vrille Maximum",
    effect:
      "Le Pokémon utilise la Force Z pour tourner à toute vitesse et écraser l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  infernoOverdrivePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour cracher une boule de feu qui réduit l’adversaire en cendres. La puissance varie selon celle de la capacité originale."
  },
  ...
  hydroVortexPhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour créer un tourbillon gigantesque qui avale l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  hydroVortexSpecial: {
    name: "Super Tourbillon Abyssal",
    effect: "Dummy Data"
  ...
  bloomDoomPhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour libérer l’énergie des plantes et attaquer l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  bloomDoomSpecial: {
    name: "Pétalexplosion Éblouissante",
    effect: "Dummu Data"
  ...
  subzeroSlammerPhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour baisser la température brutalement et congeler l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  devastatingDrakePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour matérialiser son aura et assaillir l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  blackHoleEclipsePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour rassembler l’énergie négative et y aspirer l’adversaire. La puissance varie selon celle de la capacité originale."
  },
  ...
  twinkleTacklePhysical: {
    ...
    effect:
      "Le Pokémon utilise la Force Z pour créer une dimension irréelle où l’adversaire est à sa merci. La puissance varie selon celle de la capacité originale."
  },
  ...
  clangorousSoulblaze: {
    ...
    effect:
      "Ékaïser utilise la Force Z pour frapper l’ennemi de toutes ses forces. Augmente aussi ses stats."
  },
  zippyZap: {
    name: "Pika-Sprint",
    effect:
  ...
  splishySplash: {
    name: "Pika-Splash",
    effect:
      "Pikachu frappe l’adversaire avec une vague géante chargée d’électricité. Peut aussi paralyser l’ennemi."
  },
  floatyFall: {
    name: "Pika-Piqué",
    effect:
      "Pikachu prend de la hauteur avant de fondre sur son adversaire. Peut aussi apeurer l’ennemi."
  },
  pikaPapow: {
    name: "Pika-Fracas",
  ...
  veeveeVolley: {
    name: "Évo-Chardasso",
    effect:
      "Le lanceur lance une attaque dès lors qu’un signe apparaît sur le terrain. Les dégâts infligés sont proportionnels à l’affection de votre Pokémon"
  },
  doubleIronBash: {
    name: "Écrous d’Poing",
    effect:
      "Le lanceur fait pivoter l’écrou de sa poitrine deux fois d’affilée pour frapper l’adversaire avec ses bras. Peut apeurer l’ennemi (30% de chances)."
  },
  maxGuard: {
    name: "Gardomax",
    effect:
