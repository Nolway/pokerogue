...
export const ability: AbilityTranslationEntries = {
  ...
  synchronize: {
    name: "Synchro",
    description:
      "Quand le Pokémon est brulé, paralysé ou empoisonné par un autre Pokémon, il partage ce statut avec celui-ci."
  },
  clearBody: {
    name: "Corps Sain",
    description:
  ...
  illuminate: {
    name: "Lumiattirance",
    description:
      "Le Pokémon illumine les alentours, facilitant les rencontres avec les Pokémon sauvages et empêche sa Précision de baisser."
  },
  trace: {
    name: "Calque",
    description:
  ...
  disguise: {
    name: "Fantômasque",
    description:
      "Le déguisement qui recouvre le corps du Pokémon est capable de le protéger d’une attaque."
  },
  battleBond: {
    name: "Synergie",
    description:
      "En battant un ennemi, ce Pokémon renforce ses liens avec son Dresseur, ce qui augmente son Attaque, son Attaque Spéciale et sa Vitesse."
  },
  powerConstruct: {
    name: "Rassemblement",
    description:
  ...
  thermalExchange: {
    ...
    description:
      "Lorsque le Pokémon est touché par une capacité de type Feu, il ne subit aucun dégât et son Attaque augmente."
  },
  angerShell: {
    name: "Courroupace",
    description:
  ...
  commander: {
    name: "Commandant",
    description:
      "Si un Oyacata allié est sur le terrain quand ce Pokémon rejoint le combat, ce dernier entre dans sa bouche et devient son commandant."
  },
  electromorphosis: {
    name: "Grecharge",
  ...
  supersweetSyrup: {
    ...
    description:
      "La première fois que le Pokémon entre au combat, une odeur de nectar sucré se répand sur le terrain, ce qui baisse l’Esquive de l’adversaire."
  },
  hospitality: {
  ...
  poisonPuppeteer: {
    ...
    description:
      "Lorsque Pêchaminus empoisonne un Pokémon grâce à l’une de ses capacités, ce dernier devient également confus."
  }
} as const;
