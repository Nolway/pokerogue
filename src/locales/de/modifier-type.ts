...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "Erhalte {{pokeballName}} x{{modifierCount}}. (Inventar: {{pokeballAmount}}) \nFangrate: {{catchRate}}"
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "Füllt {{restorePoints}} KP oder {{restorePercent}}% der KP für ein Pokémon auf. Je nachdem, welcher Wert höher ist.",
      extra: {
        fully: "Füllt die KP eines Pokémon wieder vollständig auf.",
        fullyWithStatus:
          "Füllt die KP eines Pokémon wieder vollständig auf und behebt alle Statusprobleme."
      }
    },
    PokemonReviveModifierType: {
      description:
        "Belebt ein kampunfähiges Pokémon wieder und stellt {{restorePercent}}% KP wieder her."
    },
    ...
    PokemonPpUpModifierType: {
      description:
        "Erhöht die maximale Anzahl der AP der ausgewählten Attacke um {{upPoints}} für jede 5 maximale AP (maximal 3)."
    },
    PokemonNatureChangeModifierType: {
      name: "{{natureName}} Minze",
      description:
        "Ändert das Wesen zu {{natureName}}. Schaltet dieses Wesen permanent für diesen Starter frei."
    },
    DoubleBattleChanceBoosterModifierType: {
      description:
        "Verdoppelt die Wahrscheinlichkeit, dass die nächsten {{battleCount}} Begegnungen mit wilden Pokémon ein Doppelkampf sind."
    },
    TempBattleStatBoosterModifierType: {
      description:
        "Erhöht die {{tempBattleStatName}} aller Teammitglieder für 5 Kämpfe um eine Stufe."
    },
    ...
    PokemonBaseStatBoosterModifierType: {
      description:
        "Erhöht den {{statName}} Basiswert des Trägers um 10%. Das Stapellimit erhöht sich, je höher dein IS-Wert ist."
    },
    ...
    AllPokemonFullReviveModifierType: {
      description:
        "Belebt alle kampunfähigen Pokémon wieder und stellt ihre KP vollständig wieder her."
    },
    ...
    PokemonExpBoosterModifierType: {
      description:
        "Erhöht die Menge der erhaltenen Erfahrungspunkte für den Träger um {{boostPercent}}%."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "Attacken treffen ein weiteres mal mit einer Reduktion von 60/75/82,5% der Stärke."
    },
    TmModifierType: {
    ...
    FusePokemonModifierType: {
      description:
        "Fusioniert zwei Pokémon (überträgt die Fähigkeit, teilt Basiswerte und Typ auf, gemeinsamer Attackenpool)."
    },
    ...
    ContactHeldItemTransferChanceModifierType: {
      description:
        "Beim Angriff besteht eine {{chancePercent}}%ige Chance, dass das getragene Item des Gegners gestohlen wird."
    },
    ...
    EnemyAttackStatusEffectChanceModifierType: {
      description:
        "Fügt Angriffen eine {{chancePercent}}%ige Chance hinzu, {{statusEffect}} zu verursachen."
    },
    ...
    MAP: {
      name: "Karte",
      description: "Ermöglicht es dir, an einer Kreuzung dein Ziel zu wählen."
    },
    ...
    REVIVER_SEED: {
      name: "Belebersamen",
      description:
        "Belebt den Träger mit der Hälfte seiner KP wieder sollte er kampfunfähig werden."
    },
    ...
    MEMORY_MUSHROOM: {
      name: "Erinnerungspilz",
      description: "Lässt ein Pokémon eine vergessene Attacke wiedererlernen."
    },

    EXP_SHARE: {
      name: "EP-Teiler",
      description:
        "Pokémon, die nicht am Kampf teilgenommen haben, bekommen 20% der Erfahrungspunkte eines Kampfteilnehmers."
    },
    EXP_BALANCE: {
      name: "EP-Ausgleicher",
      description:
        "Gewichtet die in Kämpfen erhaltenen Erfahrungspunkte auf niedrigstufigere Gruppenmitglieder."
    },

    OVAL_CHARM: {
      name: "Ovalpin",
      description:
        "Wenn mehrere Pokémon am Kampf teilnehmen, erhählt jeder von ihnen 10% extra Erfahrungspunkte."
    },
    ...
    SOUL_DEW: {
      name: "Seelentau",
      description: "Erhöht den Einfluss des Wesens eines Pokemon auf seine Werte um 10% (additiv)."
    },
    ...
    GOLDEN_PUNCH: {
      name: "Goldschlag",
      description: "Gewährt Geld in Höhe von 50% des zugefügten Schadens."
    },
    COIN_CASE: {
      name: "Münzkorb",
      description: "Erhalte nach jedem 10ten Kampf 10% Zinsen auf dein Geld."
    },

    LOCK_CAPSULE: {
      name: "Tresorkapsel",
      description:
        "Erlaubt es die Seltenheitsstufe der Items festzusetzen wenn diese neu gerollt werden."
    },
    ...
    HEALING_CHARM: {
      name: "Heilungspin",
      description:
        "Erhöht die Effektivität von Heilungsattacken sowie Heilitems um 10% (Beleber ausgenommen)."
    },
    CANDY_JAR: {
      name: "Bonbonglas",
      description: "Erhöht die Anzahl der Level die ein Sonderbonbon erhöht um 1."
    },

    BERRY_POUCH: {
      name: "Beerentüte",
      description: "Fügt eine 30% Chance hinzu, dass Beeren nicht verbraucht werden."
    },

    FOCUS_BAND: {
      name: "Fokusband",
      description:
        "Fügt eine 10% Chance hinzu, dass Angriffe die zur Kampfunfähigkeit führen mit 1 KP überlebt werden."
    },

    QUICK_CLAW: {
      name: "Quick Claw",
      description: "Fügt eine 10% Change hinzu als erster anzugreifen. (Nach Prioritätsangriffen)."
    },

    KINGS_ROCK: {
      name: "King-Stein",
      description: "Fügt eine 10% Chance hinzu, dass der Gegner nach einem Angriff zurückschreckt."
    },

    LEFTOVERS: {
      name: "Überreste",
      description: "Heilt 1/16 der maximalen KP eines Pokémon pro Runde."
    },
    SHELL_BELL: {
      name: "Muschelglocke",
      description: "Heilt den Anwender um 1/8 des von ihm zugefügten Schadens."
    },

    TOXIC_ORB: {
      name: "Toxik-Orb",
      description: "Dieser bizarre Orb vergiftet seinen Träger im Kampf schwer."
    },
    FLAME_ORB: {
      name: "Heiß-Orb",
    ...
    BATON: {
      name: "Stab",
      description:
        "Ermöglicht das Weitergeben von Effekten beim Wechseln von Pokémon, wodurch auch Fallen umgangen werden."
    },

    SHINY_CHARM: {
      name: "Schillerpin",
      description: "Erhöht die Chance deutlich, dass ein wildes Pokémon ein schillernd ist."
    },
    ABILITY_CHARM: {
      name: "Ability Charm",
      description:
        "Erhöht die Chance deutlich, dass ein wildes Pokémon eine versteckte Fähigkeit hat."
    },

    IV_SCANNER: {
      name: "IS-Scanner",
      description:
        "Erlaubt es die IS-Werte von wilden Pokémon zu scannen.\n(2 IS-Werte pro Staplung. Die besten IS-Werte zuerst)."
    },
    ...
    GOLDEN_POKEBALL: {
      name: "Goldener Pokéball",
      description: "Fügt eine zusätzliche Item-Auswahlmöglichkeit nach jedem Kampf hinzu."
    },

    ENEMY_DAMAGE_BOOSTER: { name: "Schadensmarke", description: "Erhöht den Schaden um 5%." },
    ENEMY_DAMAGE_REDUCTION: {
      name: "Schutzmarke",
      description: "Verringert den erhaltenen Schaden um 2,5%."
    },
    ENEMY_HEAL: {
      name: "Wiederherstellungsmarke",
      description: "Heilt 2% der maximalen KP pro Runde."
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "Vollheilungsmarke",
      description: "Fügt eine 2,5%ige Chance hinzu, jede Runde einen Statuszustand zu heilen."
    },
