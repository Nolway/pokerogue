...
export const PGMachv: AchievementTranslationEntries = {
  ...
  HealAchv: {
    description:
      "Heile {{healAmount}} {{HP}} auf einmal. Mit einer Attacke, Fähigkeit oder einem gehaltenen Gegenstand."
  },
  "250_HEAL": {
  ...
  TRANSFER_MAX_BATTLE_STAT: {
    name: "Teamwork",
    description:
      "Nutze Staffette, während der Anwender mindestens eines Statuswertes maximiert hat."
  },
  MAX_FRIENDSHIP: {
