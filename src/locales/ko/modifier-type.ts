...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "{{pokeballName}} {{modifierCount}}개 (현재: {{pokeballAmount}}개)를 획득한다.\n포획률: {{catchRate}}"
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "포켓몬 1마리의 HP를 {{restorePoints}} 또는 {{restorePercent}}% 중\n높은 수치만큼 회복한다.",
      extra: {
    ...
    PokemonPpUpModifierType: {
      description:
        "포켓몬이 기억하고 있는 기술 중 1개의 PP 최대치를 5마다 {{upPoints}}씩 상승시킨다 (최대 3)."
    },
    ...
    TempBattleStatBoosterModifierType: {
      description:
        "자신의 모든 포켓몬이 5번의 배틀 동안 {{tempBattleStatName}}[[가]] 한 단계 증가한다."
    },
    ...
    PokemonBaseStatBoosterModifierType: {
      description:
        "지니게 하면 {{statName}} 종족값을 10% 올려준다. 개체값이 높을수록 더 많이 누적시킬 수 있다."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "지닌 개수(최대 3개)마다 추가 공격을 하는 대신, 공격력이 60%(1개)/75%(2개)/82.5%(3개)만큼 감소합니다."
    },
    TmModifierType: {
    ...
    REVIVER_SEED: {
      name: "부활의씨앗",
      description: "포켓몬이 쓰러지려 할 때 HP를 절반 회복한다."
    },
    ...
    EXP_SHARE: {
      name: "학습장치",
      description: "배틀에 참여하지 않아도 20%의 경험치를 받을 수 있게 된다."
    },
    EXP_BALANCE: {
      name: "균형학습장치",
      description: "레벨이 낮은 포켓몬이 받는 경험치를 가중시킨다."
    },

    OVAL_CHARM: {
      name: "둥근부적",
      description:
        "여러 마리의 포켓몬이 배틀에 참여할 경우, 전체 경험치의 10%씩을 추가로 획득한다."
    },
    ...
    SOUL_DEW: {
      name: "마음의물방울",
      description: "지닌 포켓몬의 성격의 효과가 10% 증가한다 (합연산)."
    },
    ...
    COIN_CASE: {
      name: "동전케이스",
      description: "매 열 번째 배틀마다, 가진 돈의 10%를 이자로 획득한다."
    },

    LOCK_CAPSULE: {
      name: "록캡슐",
      description: "받을 아이템을 갱신할 때 희귀도를 고정시킬 수 있게 된다."
    },
    ...
    HEALING_CHARM: {
      name: "치유의부적",
      description: "HP를 회복하는 기술을 썼을 때 효율이 10% 증가한다 (부활 제외)."
    },
    CANDY_JAR: {
      name: "사탕단지",
      description: "이상한사탕 종류의 아이템이 올려주는 레벨이 1 증가한다."
    },

    BERRY_POUCH: {
      name: "열매주머니",
      description: "사용한 나무열매가 소모되지 않을 확률이 30% 추가된다."
    },

    FOCUS_BAND: {
      name: "기합의머리띠",
      description: "기절할 듯한 데미지를 받아도 HP를 1 남겨서 견딜 확률이 10% 추가된다."
    },

    QUICK_CLAW: {
      name: "선제공격손톱",
      description: "상대보다 먼저 행동할 수 있게 될 확률이 10% 추가된다 (우선도 처리 이후)."
    },

    KINGS_ROCK: {
      name: "왕의징표석",
      description: "공격해서 데미지를 줄 때 상대를 풀죽일 확률이 10% 추가된다."
    },

    LEFTOVERS: {
      name: "먹다남은음식",
      description: "포켓몬의 HP가 매 턴 최대 체력의 1/16씩 회복된다."
    },
    ...
    TOXIC_ORB: {
      name: "맹독구슬",
      description:
        "이 도구를 지닌 포켓몬은 턴이 끝나는 시점에 상태이상에 걸리지 않았다면 맹독 상태가 된다."
    },
    FLAME_ORB: {
      name: "화염구슬",
      description:
        "이 도구를 지닌 포켓몬은 턴이 끝나는 시점에 상태이상에 걸리지 않았다면 화상 상태가 된다."
    },
    ...
    SHINY_CHARM: {
      name: "빛나는부적",
      description: "야생 포켓몬이 색이 다른 포켓몬으로 등장할 확률을 급격히 높인다."
    },
    ABILITY_CHARM: {
      name: "특성부적",
      description: "야생 포켓몬이 숨겨진 특성을 가지고 등장할 확률을 급격히 높인다."
    },

    IV_SCANNER: {
      name: "개체값탐지기",
      description:
        "야생 포켓몬의 개체값을 확인 가능하다. 높은 값부터, 확인할 수 있는 개체값이 두 종류씩 추가된다."
    },
    ...
    GOLDEN_POKEBALL: {
      name: "황금몬스터볼",
      description: "전투 후 획득하는 아이템의 선택지가 하나 더 늘어난다."
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "만병통치 토큰",
      description: "매 턴 상태이상에서 회복될 확률이 2.5% 추가된다."
    },
