...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "Ganhe x{{modifierCount}} {{pokeballName}} (Mochila: {{pokeballAmount}}) \nChance de captura: {{catchRate}}."
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "Restaura {{restorePoints}} PS ou {{restorePercent}}% PS de um Pokémon, o que for maior.",
      extra: {
        fully: "Restaura totalmente os PS de um Pokémon.",
        fullyWithStatus:
          "Restaura totalmente os PS de um Pokémon e cura qualquer mudança de estado."
      }
    },
    ...
    PokemonPpUpModifierType: {
      description:
        "Aumenta permanentemente os PP para o movimento de um Pokémon em {{upPoints}} para cada 5 PP máximos (máximo 3)."
    },
    PokemonNatureChangeModifierType: {
      name: "Hortelã {{natureName}}",
      description:
        "Muda a natureza do Pokémon para {{natureName}} e a desbloqueia permanentemente."
    },
    DoubleBattleChanceBoosterModifierType: {
      description:
        "Dobra as chances de encontrar uma batalha em dupla por {{battleCount}} batalhas."
    },
    TempBattleStatBoosterModifierType: {
      description:
        "Aumenta o atributo de {{tempBattleStatName}} para todos os membros da equipe por 5 batalhas."
    },
    ...
    PokemonBaseStatBoosterModifierType: {
      description:
        "Aumenta o atributo base de {{statName}} em 10%. Quanto maior os IVs, maior o limite de aumento."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "Ataques acertam uma vez adicional ao custo de uma redução de poder de 60/75/82.5% por item, respectivamente."
    },
    TmModifierType: {
    ...
    FusePokemonModifierType: {
      description:
        "Combina dois Pokémon (transfere Habilidade, divide os atributos base e tipos, compartilha os movimentos)."
    },
    ...
    EnemyEndureChanceModifierType: {
      description:
        "Ganha {{chancePercent}}% de chance de sobreviver a um ataque que o faria desmaiar."
    },
    ...
    REVIVER_SEED: {
      ...
      description: "Após desmaiar, reanima com 50% de PS."
    },
    ...
    EXP_SHARE: {
      name: "Compart. de Exp.",
      description: "Distribui pontos de experiência para todos os membros da equipe."
    },
    EXP_BALANCE: {
      name: "Balanceador de Exp.",
      description: "Distribui pontos de experiência principalmente para os Pokémon mais fracos."
    },

    OVAL_CHARM: {
      name: "Amuleto Oval",
      description:
        "Quando vários Pokémon participam de uma batalha, cada um recebe 10% extra de pontos de experiência."
    },
    ...
    SOUL_DEW: {
      name: "Joia da Alma",
      description:
        "Aumenta a influência da natureza de um Pokémon em seus atributos em 10% (cumulativo)."
    },
    ...
    COIN_CASE: {
      name: "Moedeira",
      description: "Após cada 10ª batalha, recebe 10% de seu dinheiro em juros."
    },

    LOCK_CAPSULE: {
      name: "Cápsula de Travamento",
      description: "Permite que você trave raridades de itens ao rolar novamente."
    },
    ...
    HEALING_CHARM: {
      name: "Amuleto de Cura",
      description:
        "Aumenta a eficácia dos movimentos e itens que restauram PS em 10% (exceto Reanimador)."
    },
    CANDY_JAR: {
      name: "Pote de Doces",
      description: "Aumenta o número de níveis adicionados pelo Doce Raro em 1."
    },

    BERRY_POUCH: {
      name: "Bolsa de Berries",
      description: "Adiciona uma chance de 30% de que uma berry usada não seja consumida."
    },

    FOCUS_BAND: {
      name: "Bandana",
      description:
        "Adiciona uma chance de 10% de sobreviver com 1 PS após ser danificado o suficiente para desmaiar."
    },

    QUICK_CLAW: {
      name: "Garra Rápida",
      description:
        "Adiciona uma chance de 10% de atacar primeiro, ignorando sua velocidade (após prioridades)."
    },
    ...
    LEFTOVERS: {
      name: "Sobras",
      description: "Cura 1/16 dos PS máximos de um Pokémon a cada turno."
    },
    ...
    TOXIC_ORB: {
      name: "Esfera Tóxica",
      description:
        "Uma esfera estranha que exala toxinas quando tocada e envenena seriamente quem a segurar."
    },
    FLAME_ORB: {
    ...
    SHINY_CHARM: {
      ...
      description: "Aumenta drasticamente a chance de um Pokémon selvagem ser Shiny."
    },
    ABILITY_CHARM: {
      name: "Amuleto de Habilidade",
      description:
        "Aumenta drasticamente a chance de um Pokémon selvagem ter uma Habilidade Oculta."
    },

    IV_SCANNER: {
      name: "Scanner de IVs",
      description:
        "Permite escanear os IVs de Pokémon selvagens. 2 IVs são revelados por item. Os melhores IVs são mostrados primeiro."
    },
    ...
    GOLDEN_POKEBALL: {
      name: "Poké Bola Dourada",
      description: "Adiciona 1 opção de item extra ao final de cada batalha."
    },

    ENEMY_DAMAGE_BOOSTER: { name: "Token de Dano", description: "Aumenta o dano em 5%." },
    ENEMY_DAMAGE_REDUCTION: {
      name: "Token de Proteção",
      description: "Reduz o dano recebido em 2,5%."
    },
    ENEMY_HEAL: {
      name: "Token de Recuperação",
      description: "Cura 2% dos PS máximos a cada turno."
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "Token de Cura Total",
      description: "Adiciona uma chance de 2.5% a cada turno de curar uma condição de status."
    },
