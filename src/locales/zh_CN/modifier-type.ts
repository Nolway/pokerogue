...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "获得 {{pokeballName}} x{{modifierCount}} (已有：{{pokeballAmount}}) \n捕捉倍率：{{catchRate}}。"
    },
    ...
    OVAL_CHARM: {
      name: "圆形护符",
      description: "当多只宝可梦参与战斗，分别获得总经验值\n10%的额外经验值。"
    },
    ...
    LEFTOVERS: {
      name: "吃剩的东西",
      description: "携带该道具的宝可梦在每个回合结束时恢复\n最大HP的1/16。"
    },
    SHELL_BELL: {
      name: "贝壳之铃",
      description:
    ...
    TOXIC_ORB: {
      name: "Toxic Orb",
      description: "触碰后会放出毒的神奇宝珠。携带后，在战斗时会变成剧毒状态。"
    },
    FLAME_ORB: {
      name: "Flame Orb",
      description: "触碰后会放出热量的神奇宝珠。携带后，在战斗时会变成灼伤状态。"
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "万灵药硬币",
      description: "增加2.5%每回合治愈异常状态的概率。"
    },
