...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "Recibes {{modifierCount}}x {{pokeballName}} (En inventario: {{pokeballAmount}}) \nRatio de captura: {{catchRate}}."
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "Restaura {{restorePoints}} PS o, al menos, un {{restorePercent}}% PS de un Pokémon.",
      extra: {
        fully: "Restaura todos los PS de un Pokémon.",
        fullyWithStatus:
          "Restaura todos los PS de un Pokémon y cura todos los problemas de estados."
      }
    },
    ...
    PokemonPpUpModifierType: {
      description:
        "Aumenta permanentemente los PP para un movimiento de un Pokémon en {{upPoints}} por cada 5 PP máximo (máximo 3)."
    },
    PokemonNatureChangeModifierType: {
      name: "Menta {{natureName}}",
      description:
        "Cambia la naturaleza de un Pokémon a {{natureName}} y desbloquea permanentemente dicha naturaleza para el inicial."
    },
    DoubleBattleChanceBoosterModifierType: {
      description:
        "Duplica la posibilidad de que un encuentro sea una combate doble durante {{battleCount}} combates."
    },
    TempBattleStatBoosterModifierType: {
      description:
        "Aumenta la est. {{tempBattleStatName}} de todos los miembros del equipo en 1 nivel durante 5 combates."
    },
    AttackTypeBoosterModifierType: {
      description:
        "Aumenta la potencia de los movimientos de tipo {{moveType}} de un Pokémon en un 20%."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "Los ataques golpean una vez más a costa de una reducción de poder del 60/75/82,5% por cada objeto."
    },
    TmModifierType: {
    ...
    FusePokemonModifierType: {
      description:
        "Fusiona dos Pokémon (transfiere habilidades, divide estadísticas bases y tipos, comparte movimientos)."
    },
    ...
    ContactHeldItemTransferChanceModifierType: {
      description:
        "Al atacar, hay un {{chancePercent}}% de posibilidades de que robes el objeto que tiene el enemigo."
    },
    ...
    EnemyAttackStatusEffectChanceModifierType: {
      description:
        "Agrega un {{chancePercent}}% de probabilidad de infligir {{statusEffect}} con movimientos de ataque."
    },
    EnemyEndureChanceModifierType: {
      description:
        "Agrega un {{chancePercent}}% de probabilidad de resistir un ataque que lo debilitaría."
    },
    ...
    REVIVER_SEED: {
      ...
      description: "Revive al portador con la mitad de sus PS al debilitarse."
    },
    ...
    EXP_BALANCE: {
      name: "Equilibrar EXP",
      description:
        "Da mayor parte de la EXP recibida a los miembros del equipo que tengan menos nivel."
    },

    OVAL_CHARM: {
      name: "Amuleto Oval",
      description: "Cada Pokémon combatiente recibe un 10% adicional de la EXP total."
    },
    ...
    SOUL_DEW: {
      name: "Rocío bondad",
      description:
        "Aumenta la influencia de la naturaleza de un Pokémon en sus estadísticas en un 10% (aditivo)."
    },
    ...
    GOLDEN_PUNCH: {
      name: "Puño Dorado",
      description: "Otorga el 50% del daño infligido como dinero."
    },
    COIN_CASE: {
      name: "Monedero",
      description: "Después de cada 10 combates, recibe el 10% de tu dinero en intereses."
    },
    ...
    HEALING_CHARM: {
      ...
      description:
        "Aumenta la efectividad de los movimientos y objetos de curacion de PS en un 10% (excepto revivir)."
    },
    CANDY_JAR: {
      name: "Candy Jar",
      description: "Aumenta en 1 el número de niveles añadidos por los carameloraros."
    },
    ...
    QUICK_CLAW: {
      name: "Garra Rápida",
      description:
        "Agrega un 10% de probabilidad de atacar primero independientemente de la velocidad (después de la prioridad)."
    },
    ...
    TOXIC_ORB: {
      name: "Toxiesfera",
      description: "Extraña esfera que envenena gravemente a quien la usa en combate."
    },
    FLAME_ORB: {
      name: "Llamasfera",
    ...
    ABILITY_CHARM: {
      ...
      description:
        "Aumenta drásticamente la posibilidad de que un Pokémon salvaje tenga una habilidad oculta."
    },

    IV_SCANNER: {
      name: "Escáner IV",
      description:
        "Permite escanear los IVs de Pokémon salvajes. Se revelan 2 IVs por cada objeto.\nLos mejores IVs se muestran primero."
    },
