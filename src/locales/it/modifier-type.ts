...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "Ricevi {{pokeballName}} x{{modifierCount}} (Inventario: {{pokeballAmount}}) \nTasso di cattura: {{catchRate}}."
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "Restituisce {{restorePoints}} PS o {{restorePercent}}% PS ad un Pokémon, a seconda del valore più alto.",
      extra: {
    ...
    PokemonNatureChangeModifierType: {
      ...
      description:
        "Cambia la natura del Pokémon in {{natureName}} e sblocca la natura per il Pokémon iniziale."
    },
    DoubleBattleChanceBoosterModifierType: {
      description:
        "Raddoppia la possibilità di imbattersi in doppie battaglie per {{battleCount}} battaglie."
    },
    TempBattleStatBoosterModifierType: {
      description:
        "Aumenta {{tempBattleStatName}} di un livello a tutti i Pokémon nel gruppo per 5 battaglie."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "Gli attacchi colpiscono una volta in più al costo di una riduzione di potenza del 60/75/82,5% per mossa."
    },
    TmModifierType: {
    ...
    FusePokemonModifierType: {
      description:
        "Combina due Pokémon (trasferisce i poteri, divide le statistiche e i tipi base, condivide il pool di mosse)."
    },
    ...
    ContactHeldItemTransferChanceModifierType: {
      description:
        "Quando si attacca, c'è una probabilità del {{chancePercent}}% che l'oggetto in possesso del nemico venga rubato."
    },
    ...
    EnemyAttackStatusEffectChanceModifierType: {
      description:
        "Aggiunge una probabilità del {{chancePercent}}% di infliggere {{statusEffect}} con le mosse d'attacco."
    },
    ...
    REVIVER_SEED: {
      name: "Revitalseme",
      description: "Il possessore recupera 1/2 di PS in caso di svenimento."
    },
    ...
    MEMORY_MUSHROOM: {
      name: "Fungo della Memoria",
      description: "Ricorda la mossa dimenticata di un Pokémon."
    },

    EXP_SHARE: {
      name: "Condividi Esperienza",
      description:
        "Tutti i Pokémon della squadra ricevono il 20% dei Punti Esperienza dalla lotta anche se non vi hanno partecipato."
    },
    EXP_BALANCE: {
      name: "Bilancia Esperienza",
      description:
        "Bilancia i Punti Esperienza ricevuti verso i Pokémon del gruppo di livello inferiore."
    },

    OVAL_CHARM: {
      name: "Ovamuleto",
      description:
        "Quando più Pokémon partecipano a una battaglia, ognuno di essi riceve il 10% in più dell'esperienza totale."
    },
    ...
    SOUL_DEW: {
      name: "Cuorugiada",
      description:
        "Aumenta del 10% l'influenza della natura di un Pokémon sulle sue statistiche (Aggiuntivo)."
    },
    ...
    GOLDEN_PUNCH: {
      name: "Pugno Dorato",
      description: "Garantisce il 50% dei danni inflitti come denaro."
    },
    COIN_CASE: {
      name: "	Salvadanaio",
      description: "Dopo ogni 10° battaglia, riceverete il 10% del vostro denaro in interessi."
    },

    LOCK_CAPSULE: {
      name: "Capsula Scrigno",
      description:
        "Permette di bloccare le rarità degli oggetti quando si fa un reroll degli oggetti."
    },
    ...
    HEALING_CHARM: {
      name: "Curamuleto",
      description:
        "Aumenta del 10% l'efficacia delle mosse e degli oggetti che ripristinano i PS (escluse le rianimazioni)."
    },
    CANDY_JAR: {
      name: "Barattolo di caramelle",
      description: "Aumenta di 1 il numero di livelli aggiunti dalle Caramelle Rare."
    },

    BERRY_POUCH: {
      name: "Porta Bacche",
      description: "Aggiunge il 30% di possibilità che una bacca usata non venga consumata."
    },

    FOCUS_BAND: {
      name: "Bandana",
      description:
        "Chi ce l'ha ottiene il 10% di possibilità aggiuntivo di evitare un potenziale KO e rimanere con un solo PS."
    },

    QUICK_CLAW: {
      name: "Rapidartigli",
      description:
        "Aggiunge una probabilità del 10% di muoversi per primi, indipendentemente dalla velocità (dopo la priorità)."
    },

    KINGS_ROCK: {
      name: "Roccia di re",
      description:
        "Aggiunge il 10% di possibilità che una mossa d'attacco faccia tentennare l'avversario."
    },

    LEFTOVERS: {
      name: "Avanzi",
      description: "Ripristina 1/16 dei PS massimi di un Pokémon ogni turno."
    },
    SHELL_BELL: {
      name: "Conchinella",
      description: "Guarisce 1/8 del danno inflitto a un Pokémon."
    },

    TOXIC_ORB: {
      name: "Tossicsfera",
      description: "Sfera bizzarra che iperavvelena chi l’ha con sé in una lotta."
    },
    FLAME_ORB: {
      name: "Fiammosfera",
      description: "Sfera bizzarra che procura una scottatura a chi l’ha con sé in una lotta."
    },

    BATON: {
      name: "Staffetta",
      description:
        "Permette di trasmettere gli effetti quando si cambia Pokémon, aggirando anche le trappole."
    },

    SHINY_CHARM: {
      name: "Cromamuleto",
      description:
        "Misterioso amuleto luminoso che aumenta la probabilità di incontrare Pokémon cromatici."
    },
    ABILITY_CHARM: {
      name: "Abilitamuleto",
      description:
        "Aumenta drasticamente la possibilità che un Pokémon selvatico abbia un'abilità nascosta."
    },

    IV_SCANNER: {
      name: "Scanner IV",
      description:
        "Permette di scansionare gli IV dei Pokémon selvatici. Vengono rivelati 2 IV per pila. I migliori IV vengono mostrati per primi."
    },
    ...
    GOLDEN_POKEBALL: {
      name: "Poké Ball Oro",
      description: "Aggiunge 1 opzione di oggetto extra alla fine di ogni battaglia."
    },

    ENEMY_DAMAGE_BOOSTER: { name: "Gettone del Danno", description: "Aumenta il danno del 5%." },
    ENEMY_DAMAGE_REDUCTION: {
      name: "Gettone della Protezione",
      description: "Riduce i danni ricevuti del 2.5%."
    },
    ENEMY_HEAL: {
      name: "Gettone del Recupero",
      description: "Cura il 2% dei PS massimi ogni turno."
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      name: "Gettone Guarigione Completa",
      description:
        "Aggiunge una probabilità del 2.5% a ogni turno di curare una condizione di stato."
    },
    ENEMY_ENDURE_CHANCE: { name: "Gettone di Resistenza" },
    ENEMY_FUSED_CHANCE: {
      name: "Gettone della fusione",
