...
export const menu: SimpleTranslationEntries = {
  ...
  disclaimerDescription:
    "Questo gioco è un prodotto incompleto; si potrebbero riscontrare errori (inclusa la perdita dei dati di salvataggio),\ncambiamenti impercettibili, e non è detto che venga aggiornato nel tempo o mai completato del tutto."
} as const;
