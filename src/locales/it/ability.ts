...
export const ability: AbilityTranslationEntries = {
  ...
  synchronize: {
    name: "Sincronismo",
    description:
      "Se un Pokémon con questa abilità viene avvelenato, paralizzato o scottato, contagia con lo stesso problema di stato chi lo ha causato."
  },
  clearBody: {
    name: "Corpochiaro",
    description:
  ...
  illuminate: {
    name: "Risplendi",
    description:
      "Illuminando l'ambiente circostante, impedisce che la precisione del pokémon sia diminuita."
  },
  trace: {
    name: "Traccia",
  ...
  commander: {
    ...
    description:
      "Quando il Pokémon entra in campo ed è presente un Dondozo alleato, si ficca nella bocca di quest'ultimo e da lì impartisce ordini."
  },
  electromorphosis: {
    name: "Convertivolt",
  ...
  poisonPuppeteer: {
    name: "	Malia Tossica",
    description:
      "I Pokémon avvelenati dalle mosse di Pecharunt entreranno anche in stato di confusione."
  }
} as const;
