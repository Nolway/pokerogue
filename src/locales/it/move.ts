...
export const move: MoveTranslationEntries = {
  ...
  letsSnuggleForever: {
    ...
    effect:
      "Grazie al Potere Z, Mimikyu fa appello a tutte le sue forze e attacca il bersaglio tempestandolo di colpi."
  },
  ...
  zippyZap: {
    name: "Sprintaboom",
    effect:
      "The user attacks the target with bursts of electricity at high speed. This move always goes first and raises the user's evasiveness."
  },
  splishySplash: {
    name: "Surfasplash",
    effect:
  ...
  bouncyBubble: {
    name: "Bollaslurp",
    effect:
      "Chi la usa colpisce il bersaglio con una raffica di bolle, per poi assorbirle e recuperare una quantità di PS pari alla del danno inferto."
  },
  buzzyBuzz: {
    name: "Elettrozap",
  ...
  maxGuard: {
    name: "Dynabarriera",
    effect:
      "Questa mossa permette di eludere tutti gli attacchi. Se usata in successione può fallire."
  },
  dynamaxCannon: {
  ...
  maxFlutterby: {
    name: "Dynainsetto",
    effect:
      "Un attacco di tipo Coleottero che può essere eseguito dai Pokémon dynamaxizzati. Riduce l'Attacco Speciale degli avversari."
  },
  maxLightning: {
    name: "Dynasaetta",
    effect:
  ...
  maxStrike: {
    name: "Dynattacco",
    effect:
      "Un attacco di tipo Normale che può essere eseguito dai Pokémon dynamaxizzati. Riduce la Velocità degli avversari."
  },
  maxKnuckle: {
    name: "Dynapugno",
    effect:
  ...
  maxPhantasm: {
    name: "Dynavuoto",
    effect:
      "Un attacco di tipo Spettro che può essere eseguito dai Pokémon dynamaxizzati. Riduce la Difesa degli avversari."
  },
  maxHailstorm: {
    name: "Dynagelo",
    effect:
      "Un attacco di tipo Ghiaccio che può essere eseguito dai Pokémon dynamaxizzati. Causa una nevicata che dura per cinque turni."
  },
  maxOoze: {
    name: "Dynacorrosione",
    effect:
  ...
  maxWyrmwind: {
    name: "Dynadragone",
    effect:
      "Un attacco di tipo Drago che può essere eseguito dai Pokémon dynamaxizzati. Riduce l'Attacco degli avversari."
  },
  maxMindstorm: {
    name: "Dynapsiche",
    effect:
  ...
  maxDarkness: {
    name: "Dynatenebre",
    effect:
      "Un attacco di tipo Buio che può essere eseguito dai Pokémon dynamaxizzati. Riduce la Difesa Speciale degli avversari."
  },
  maxOvergrowth: {
    name: "Dynaflora",
    effect:
      "Un attacco di tipo Erba che può essere eseguito dai Pokémon dynamaxizzati. Per cinque turni il terreno entra nello stato di Campo Erboso."
  },
  maxSteelspike: {
    name: "Dynametallo",
    effect:
  ...
  auraWheel: {
    name: "Ruota d'Aura",
    effect:
      "Il Pokémon emette l'energia accumulata nelle guance per attaccare e aumentare la Velocità. Il tipo della mossa cambia in base alla forma assunta da Morpeko."
  },
  breakingSwipe: {
    name: "Vastoimpatto",
  ...
  fieryWrath: {
    name: "Furia Ardente",
    effect:
      "ERR	Il Pokémon attacca trasformando la sua rabbia in un'aura simile a fiamme. Può anche far tentennare il bersaglio.ORE"
  },
  thunderousKick: {
    name: "Calcio Tonante",
    effect:
  ...
  gMaxWildfire: {
    name: "Gigavampa",
    effect:
      "Attacco di tipo Fuoco eseguito da Charizard Gigamax. Infligge danni per quattro turni."
  },
  gMaxBefuddle: {
    name: "Gigastupore",
    effect:
  ...
  gMaxGoldRush: {
    name: "Gigamonete",
    effect:
      "Attacco di tipo Normale eseguito da Meowth Gigamax. Confonde i nemici e permette anche di ricevere una ricompensa maggiore."
  },
  gMaxChiStrike: {
  ...
  gMaxTerror: {
    name: "Gigaillusione",
    effect:
      "Attacco di tipo Spettro eseguito da Gengar Gigamax. Il Pokémon calpesta l'ombra del nemico impedendogli la fuga o la sostituzione."
  },
  gMaxResonance: {
    name: "Gigamelodia",
    effect:
      "Attacco di tipo Ghiaccio eseguito da Lapras Gigamax. Riduce i danni subiti per cinque turni."
  },
  gMaxCuddle: {
    name: "Gigabbraccio",
  ...
  gMaxStonesurge: {
    ...
    effect:
      "Attacco di tipo Acqua eseguito da Drednaw Gigamax. Sparge rocce aguzze sul campo di lotta."
  },
  gMaxWindRage: {
    name: "Gigaciclone",
    effect:
      "Attacco di tipo Volante eseguito da Corviknight Gigamax. Annulla l'effetto di mosse come Riflesso e Schermoluce."
  },
  gMaxStunShock: {
    name: "Gigatoxiscossa",
    effect:
      "Attacco di tipo Elettro eseguito da Toxtricity Gigamax. Avvelena o paralizza i nemici."
  },
  gMaxFinale: {
    name: "Gigagranfinale",
  ...
  gMaxDepletion: {
    ...
    effect:
      "Attacco di tipo Drago eseguito da Duraludon Gigamax. Toglie PP all'ultima mossa usata dai nemici."
  },
  gMaxGravitas: {
    name: "Gigagravitoforza",
    effect:
      "Attacco di tipo Psico eseguito da Orbeetle Gigamax. Cambia la gravità per cinque turni."
  },
  gMaxVolcalith: {
    name: "Gigalapilli",
    effect:
  ...
  gMaxSandblast: {
    ...
    effect:
      "Attacco di tipo Terra eseguito da Sandaconda Gigamax. Scatena un turbine di sabbia per quattro o cinque turni."
  },
  gMaxSnooze: {
    name: "Gigatorpore",
    effect:
      "Attacco di tipo Buio eseguito da Grimmsnarl Gigamax. Chi la usa fa un grande sbadiglio che fa addormentare il nemico al turno successivo."
  },
  gMaxTartness: {
  ...
  gMaxSweetness: {
    name: "Gigambrosia",
    effect:
      "Attacco di tipo Erba eseguito da Appletun Gigamax. Cura i problemi di stato degli alleati."
  },
  gMaxSmite: {
    name: "Gigacastigo",
  ...
  gMaxSteelsurge: {
    ...
    effect:
      "Attacco di tipo Acciaio eseguito da Copperajah Gigamax. Sparge pezzi di metallo acuminati sul campo di lotta."
  },
  gMaxMeltdown: {
    name: "Gigaliquefazione",
    effect:
      "ERAttacco di tipo Acciaio eseguito da Melmetal Gigamax. Impedisce ai nemici di usare la stessa mossa due volte di seguito.RORE"
  },
  gMaxFoamBurst: {
    name: "Gigaschiuma",
    effect:
      "Attacco di tipo Acqua eseguito da Kingler Gigamax. Riduce di molto la Velocità dei nemici."
  },
  gMaxCentiferno: {
    name: "Gigamillefiamme",
    effect:
      "Attacco di tipo Fuoco eseguito da Centiskorch Gigamax. Intrappola i nemici nelle fiamme per quattro o cinque turni."
  },
  gMaxVineLash: {
    name: "Gigasferzata",
  ...
  gMaxCannonade: {
    name: "Gigacannonata",
    effect:
      "Attacco di tipo Acqua eseguito da Blastoise Gigamax. Infligge danni per quattro turni."
  },
  gMaxDrumSolo: {
    name: "Gigarullio",
  ...
  gMaxOneBlow: {
    ...
    effect:
      "Attacco di tipo Buio eseguito da Urshifu Gigamax che ignora gli effetti della Dynabarriera."
  },
  gMaxRapidFlow: {
    name: "Gigapluricolpo",
    effect:
      "	Attacco di tipo Acqua eseguito da Urshifu Gigamax che ignora gli effetti della Dynabarriera."
  },
  teraBlast: {
    name: "Terascoppio",
    effect:
