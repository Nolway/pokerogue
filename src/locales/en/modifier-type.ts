...
export const modifierType: ModifierTypeTranslationEntries = {
  ModifierType: {
    AddPokeballModifierType: {
      ...
      description:
        "Receive {{pokeballName}} x{{modifierCount}} (Inventory: {{pokeballAmount}}) \nCatch Rate: {{catchRate}}"
    },
    ...
    PokemonHpRestoreModifierType: {
      description:
        "Restores {{restorePoints}} HP or {{restorePercent}}% HP for one Pokémon, whichever is higher.",
      extra: {
    ...
    PokemonPpUpModifierType: {
      description:
        "Permanently increases PP for one Pokémon move by {{upPoints}} for every 5 maximum PP (maximum 3)."
    },
    PokemonNatureChangeModifierType: {
      name: "{{natureName}} Mint",
      description:
        "Changes a Pokémon's nature to {{natureName}} and permanently unlocks the nature for the starter."
    },
    DoubleBattleChanceBoosterModifierType: {
      description:
        "Doubles the chance of an encounter being a double battle for {{battleCount}} battles."
    },
    TempBattleStatBoosterModifierType: {
      description:
        "Increases the {{tempBattleStatName}} of all party members by 1 stage for 5 battles."
    },
    ...
    PokemonBaseStatBoosterModifierType: {
      description:
        "Increases the holder's base {{statName}} by 10%. The higher your IVs, the higher the stack limit."
    },
    ...
    PokemonMultiHitModifierType: {
      description:
        "Attacks hit one additional time at the cost of a 60/75/82.5% power reduction per stack respectively."
    },
    TmModifierType: {
    ...
    FusePokemonModifierType: {
      description:
        "Combines two Pokémon (transfers Ability, splits base stats and types, shares move pool)."
    },
    ...
    ContactHeldItemTransferChanceModifierType: {
      description:
        "Upon attacking, there is a {{chancePercent}}% chance the foe's held item will be stolen."
    },
    ...
    EnemyAttackStatusEffectChanceModifierType: {
      description:
        "Adds a {{chancePercent}}% chance to inflict {{statusEffect}} with attack moves."
    },
    ...
    OVAL_CHARM: {
      name: "Oval Charm",
      description:
        "When multiple Pokémon participate in a battle, each gets an extra 10% of the total EXP."
    },
    ...
    GOLDEN_PUNCH: {
      name: "Golden Punch",
      description: "Grants 50% of direct damage inflicted as money."
    },
    COIN_CASE: {
      name: "Coin Case",
    ...
    HEALING_CHARM: {
      name: "Healing Charm",
      description:
        "Increases the effectiveness of HP restoring moves and items by 10% (excludes Revives)."
    },
    CANDY_JAR: {
      name: "Candy Jar",
    ...
    BERRY_POUCH: {
      name: "Berry Pouch",
      description: "Adds a 30% chance that a used berry will not be consumed."
    },
    ...
    QUICK_CLAW: {
      name: "Quick Claw",
      description: "Adds a 10% chance to move first regardless of speed (after priority)."
    },
    ...
    BATON: {
      name: "Baton",
      description:
        "Allows passing along effects when switching Pokémon, which also bypasses traps."
    },
    ...
    IV_SCANNER: {
      name: "IV Scanner",
      description:
        "Allows scanning the IVs of wild Pokémon. 2 IVs are revealed per stack. The best IVs are shown first."
    },
    ...
    ENEMY_STATUS_EFFECT_HEAL_CHANCE: {
      ...
      description: "Adds a 2.5% chance every turn to heal a status condition."
    },
