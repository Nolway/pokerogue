...
export const move: MoveTranslationEntries = {
  ...
  bouncyBubble: {
    name: "Bouncy Bubble",
    effect:
      "The user attacks by shooting water bubbles at the target. It then absorbs water and restores its HP by the damage taken by the target."
  },
  buzzyBuzz: {
    name: "Buzzy Buzz",
    effect:
  ...
  dynamaxCannon: {
    name: "Dynamax Cannon",
    effect:
      "The user unleashes a strong beam from its core. This move deals twice the damage if the target is over level 200."
  },
  snipeShot: {
    name: "Snipe Shot",
    effect:
