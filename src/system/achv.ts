...
export class Achv {
  ...
  getName(playerGender: PlayerGender): string {
    ...
    return i18next.t(`${prefix}achv:${this.localizationKey}.name`);
  }
...
export class RibbonAchv extends Achv {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      score,
      (scene: BattleScene, _args: any[]) =>
        scene.gameData.gameStats.ribbonsOwned >= this.ribbonAmount
    );
  ...
  constructor(
    ...
    super(
      ...
      (_scene: BattleScene, args: any[]) =>
        (args[0] as Utils.NumberHolder).value >= this.damageAmount
    );
...
export class HealAchv extends Achv {
  ...
  constructor(
    ...
    super(
      ...
      score,
      (_scene: BattleScene, args: any[]) =>
        (args[0] as Utils.NumberHolder).value >= this.healAmount
    );
...
export class LevelAchv extends Achv {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      score,
      (scene: BattleScene, args: any[]) => (args[0] as Utils.IntegerHolder).value >= this.level
    );
    this.level = level;
  }
}
...
export class ModifierAchv extends Achv {
  constructor(
    ...
    super(
      ...
      iconImage,
      score,
      (_scene: BattleScene, args: any[]) => modifierFunc(args[0] as Modifier)
    );
  }
}
...
export class ChallengeAchv extends Achv {
  constructor(
    ...
    super(
      ...
      iconImage,
      score,
      (_scene: BattleScene, args: any[]) => challengeFunc(args[0] as Challenge)
    );
  }
}
...
export function getAchievementDescription(localizationKey: string): string {
  ...
  case "10K_MONEY":
    return i18next.t(`${genderPrefix}achv:MoneyAchv.description`, {
  ...
  case "250_DMG":
    return i18next.t(`${genderPrefix}achv:DamageAchv.description`, {
  ...
  case "250_HEAL":
    return i18next.t(`${genderPrefix}achv:HealAchv.description`, {
      healAmount: achvs._250_HEAL.healAmount.toLocaleString("en-US"),
      HP: i18next.t("pokemonInfo:Stat.HPshortened")
    });
  case "1000_HEAL":
    return i18next.t(`${genderPrefix}achv:HealAchv.description`, {
  ...
  case "LV_100":
    return i18next.t(`${genderPrefix}achv:LevelAchv.description`, { level: achvs.LV_100.level });
  case "LV_250":
    return i18next.t(`${genderPrefix}achv:LevelAchv.description`, { level: achvs.LV_250.level });
  case "LV_1000":
    return i18next.t(`${genderPrefix}achv:LevelAchv.description`, { level: achvs.LV_1000.level });
  case "10_RIBBONS":
    return i18next.t(`${genderPrefix}achv:RibbonAchv.description`, {
  ...
  case "TRANSFER_MAX_BATTLE_STAT":
    return i18next.t(`${genderPrefix}achv:TRANSFER_MAX_BATTLE_STAT.description`);
  case "MAX_FRIENDSHIP":
    return i18next.t(`${genderPrefix}achv:MAX_FRIENDSHIP.description`);
  case "MEGA_EVOLVE":
    return i18next.t(`${genderPrefix}achv:MEGA_EVOLVE.description`);
  case "GIGANTAMAX":
    return i18next.t(`${genderPrefix}achv:GIGANTAMAX.description`);
  case "TERASTALLIZE":
    return i18next.t(`${genderPrefix}achv:TERASTALLIZE.description`);
  case "STELLAR_TERASTALLIZE":
    return i18next.t(`${genderPrefix}achv:STELLAR_TERASTALLIZE.description`);
  case "SPLICE":
    return i18next.t(`${genderPrefix}achv:SPLICE.description`);
  case "MINI_BLACK_HOLE":
    return i18next.t(`${genderPrefix}achv:MINI_BLACK_HOLE.description`);
  case "CATCH_MYTHICAL":
    return i18next.t(`${genderPrefix}achv:CATCH_MYTHICAL.description`);
  case "CATCH_SUB_LEGENDARY":
    return i18next.t(`${genderPrefix}achv:CATCH_SUB_LEGENDARY.description`);
  case "CATCH_LEGENDARY":
    return i18next.t(`${genderPrefix}achv:CATCH_LEGENDARY.description`);
  case "SEE_SHINY":
    return i18next.t(`${genderPrefix}achv:SEE_SHINY.description`);
  case "SHINY_PARTY":
    return i18next.t(`${genderPrefix}achv:SHINY_PARTY.description`);
  case "HATCH_MYTHICAL":
    return i18next.t(`${genderPrefix}achv:HATCH_MYTHICAL.description`);
  case "HATCH_SUB_LEGENDARY":
    return i18next.t(`${genderPrefix}achv:HATCH_SUB_LEGENDARY.description`);
  case "HATCH_LEGENDARY":
    return i18next.t(`${genderPrefix}achv:HATCH_LEGENDARY.description`);
  case "HATCH_SHINY":
    return i18next.t(`${genderPrefix}achv:HATCH_SHINY.description`);
  case "HIDDEN_ABILITY":
    return i18next.t(`${genderPrefix}achv:HIDDEN_ABILITY.description`);
  case "PERFECT_IVS":
    return i18next.t(`${genderPrefix}achv:PERFECT_IVS.description`);
  case "CLASSIC_VICTORY":
    return i18next.t(`${genderPrefix}achv:CLASSIC_VICTORY.description`);
  case "MONO_GEN_ONE":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_ONE.description`);
  case "MONO_GEN_TWO":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_TWO.description`);
  case "MONO_GEN_THREE":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_THREE.description`);
  case "MONO_GEN_FOUR":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_FOUR.description`);
  case "MONO_GEN_FIVE":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_FIVE.description`);
  case "MONO_GEN_SIX":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_SIX.description`);
  case "MONO_GEN_SEVEN":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_SEVEN.description`);
  case "MONO_GEN_EIGHT":
    return i18next.t(`${genderPrefix}achv:MONO_GEN_EIGHT.description`);
  case "MONO_GEN_NINE":
  ...
  case "MONO_DARK":
  case "MONO_FAIRY":
    return i18next.t(`${genderPrefix}achv:MonoType.description`, {
...
export const achvs = {
  ...
  TRANSFER_MAX_BATTLE_STAT: new Achv(
    "TRANSFER_MAX_BATTLE_STAT",
    "",
    "TRANSFER_MAX_BATTLE_STAT.description",
    "stick",
    20
  ),
  ...
  CATCH_MYTHICAL: new Achv(
    "CATCH_MYTHICAL",
    "",
    "CATCH_MYTHICAL.description",
    "strange_ball",
    50
  ).setSecret(),
  CATCH_SUB_LEGENDARY: new Achv(
    "CATCH_SUB_LEGENDARY",
    "",
    "CATCH_SUB_LEGENDARY.description",
    "rb",
    75
  ).setSecret(),
  CATCH_LEGENDARY: new Achv(
    "CATCH_LEGENDARY",
    "",
    "CATCH_LEGENDARY.description",
    "mb",
    100
  ).setSecret(),
  SEE_SHINY: new Achv("SEE_SHINY", "", "SEE_SHINY.description", "pb_gold", 75),
  SHINY_PARTY: new Achv("SHINY_PARTY", "", "SHINY_PARTY.description", "shiny_charm", 100).setSecret(
    true
  ),
  HATCH_MYTHICAL: new Achv(
    "HATCH_MYTHICAL",
    "",
    "HATCH_MYTHICAL.description",
    "pair_of_tickets",
    75
  ).setSecret(),
  ...
  HATCH_LEGENDARY: new Achv(
    "HATCH_LEGENDARY",
    "",
    "HATCH_LEGENDARY.description",
    "mystic_ticket",
    125
  ).setSecret(),
  HATCH_SHINY: new Achv(
    "HATCH_SHINY",
    "",
    "HATCH_SHINY.description",
    "golden_mystic_ticket",
    100
  ).setSecret(),
  ...
  MONO_GEN_ONE_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 1
  ),
  MONO_GEN_TWO_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 2
  ),
  MONO_GEN_THREE_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 3
  ),
  MONO_GEN_FOUR_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 4
  ),
  MONO_GEN_FIVE_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 5
  ),
  MONO_GEN_SIX_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 6
  ),
  MONO_GEN_SEVEN_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 7
  ),
  MONO_GEN_EIGHT_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 8
  ),
  MONO_GEN_NINE_VICTORY: new ChallengeAchv(
    ...
    "mystic_ticket",
    100,
    (c) => c instanceof SingleGenerationChallenge && c.value === 9
  ),
  MONO_NORMAL: new ChallengeAchv(
    ...
    "silk_scarf",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 1
  ),
  MONO_FIGHTING: new ChallengeAchv(
    ...
    "black_belt",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 2
  ),
  MONO_FLYING: new ChallengeAchv(
    ...
    "sharp_beak",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 3
  ),
  MONO_POISON: new ChallengeAchv(
    ...
    "poison_barb",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 4
  ),
  MONO_GROUND: new ChallengeAchv(
    ...
    "soft_sand",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 5
  ),
  MONO_ROCK: new ChallengeAchv(
    ...
    "hard_stone",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 6
  ),
  MONO_BUG: new ChallengeAchv(
    ...
    "silver_powder",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 7
  ),
  MONO_GHOST: new ChallengeAchv(
    ...
    "spell_tag",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 8
  ),
  MONO_STEEL: new ChallengeAchv(
    ...
    "metal_coat",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 9
  ),
  MONO_FIRE: new ChallengeAchv(
    ...
    "charcoal",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 10
  ),
  MONO_WATER: new ChallengeAchv(
    ...
    "mystic_water",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 11
  ),
  MONO_GRASS: new ChallengeAchv(
    ...
    "miracle_seed",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 12
  ),
  MONO_ELECTRIC: new ChallengeAchv(
    ...
    "magnet",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 13
  ),
  MONO_PSYCHIC: new ChallengeAchv(
    ...
    "twisted_spoon",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 14
  ),
  MONO_ICE: new ChallengeAchv(
    ...
    "never_melt_ice",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 15
  ),
  MONO_DRAGON: new ChallengeAchv(
    ...
    "dragon_fang",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 16
  ),
  MONO_DARK: new ChallengeAchv(
    ...
    "black_glasses",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 17
  ),
  MONO_FAIRY: new ChallengeAchv(
    ...
    "fairy_feather",
    100,
    (c) => c instanceof SingleTypeChallenge && c.value === 18
  )
};
