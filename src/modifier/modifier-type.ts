...
import {
  TempBattleStat,
  getTempBattleStatBoosterItemName,
  getTempBattleStatName
} from "../data/temp-battle-stat";
  ...
  getOrInferTier(poolType: ModifierPoolType = ModifierPoolType.PLAYER): ModifierTier {
    ...
    for (const type of poolTypes) {
      ...
      for (const tier of Object.values(ModifierTier)) {
        ...
        if (pool[tier].find((m) => m.modifierType.id === (this.generatorId || this.id))) {
...
class AddPokeballModifierType extends ModifierType {
  ...
  constructor(iconImage: string, pokeballType: PokeballType, count: integer) {
    super(
      "",
      iconImage,
      (_type, _args) => new Modifiers.AddPokeballModifier(this, pokeballType, count),
      "pb",
      "pb_bounce_1"
    );
...
class AddVoucherModifierType extends ModifierType {
  ...
  constructor(voucherType: VoucherType, count: integer) {
    super(
      ...
      (_type, _args) => new Modifiers.AddVoucherModifier(this, voucherType, count),
      "voucher"
    );
    this.count = count;
    ...
    super(
      ...
      (pokemon: PlayerPokemon) => {
        ...
        const matchingModifier = pokemon.scene.findModifier(
          (m) =>
            m instanceof Modifiers.PokemonHeldItemModifier &&
            m.pokemonId === pokemon.id &&
            m.matchType(dummyModifier)
        ) as Modifiers.PokemonHeldItemModifier;
...
export class PokemonHpRestoreModifierType extends PokemonModifierType {
  ...
  constructor(
    ...
    super(
      ...
      newModifierFunc ||
        ((_type, args) =>
          new Modifiers.PokemonHpRestoreModifier(
            this,
...
export class PokemonPpRestoreModifierType extends PokemonMoveModifierType {
  ...
  constructor(localeKey: string, iconImage: string, restorePoints: integer) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonPpRestoreModifier(
          this,
          (args[0] as PlayerPokemon).id,
          args[1] as integer,
          this.restorePoints
...
export class PokemonAllMovePpRestoreModifierType extends PokemonModifierType {
  ...
  constructor(localeKey: string, iconImage: string, restorePoints: integer) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonAllMovePpRestoreModifier(
          this,
          (args[0] as PlayerPokemon).id,
          this.restorePoints
        ),
...
export class PokemonPpUpModifierType extends PokemonMoveModifierType {
  ...
  constructor(localeKey: string, iconImage: string, upPoints: integer) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonPpUpModifier(
          this,
          (args[0] as PlayerPokemon).id,
          args[1] as integer,
          this.upPoints
...
export class PokemonNatureChangeModifierType extends PokemonModifierType {
  ...
  constructor(nature: Nature) {
    super(
      ...
      (_type, args) =>
        new Modifiers.PokemonNatureChangeModifier(this, (args[0] as PlayerPokemon).id, this.nature),
      (pokemon: PlayerPokemon) => {
...
export class RememberMoveModifierType extends PokemonModifierType {
  constructor(localeKey: string, iconImage: string, group?: string) {
    super(
      ...
      iconImage,
      (type, args) =>
        new Modifiers.RememberMoveModifier(type, (args[0] as PlayerPokemon).id, args[1] as integer),
      (pokemon: PlayerPokemon) => {
...
export class DoubleBattleChanceBoosterModifierType extends ModifierType {
  ...
  constructor(localeKey: string, iconImage: string, battleCount: integer) {
    super(
      localeKey,
      iconImage,
      (_type, _args) => new Modifiers.DoubleBattleChanceBoosterModifier(this, this.battleCount),
      "lure"
    );
...
export class TempBattleStatBoosterModifierType
  ...
  constructor(tempBattleStat: TempBattleStat) {
    super(
      "",
      getTempBattleStatBoosterItemName(tempBattleStat)
        .replace(/\./g, "")
        .replace(/[ ]/g, "_")
        .toLowerCase(),
  ...
  get name(): string {
    return i18next.t(
      `modifierType:TempBattleStatBoosterItem.${getTempBattleStatBoosterItemName(this.tempBattleStat).replace(/\./g, "").replace(/[ ]/g, "_").toLowerCase()}`
    );
  }

  getDescription(scene: BattleScene): string {
    return i18next.t("modifierType:ModifierType.TempBattleStatBoosterModifierType.description", {
      tempBattleStatName: getTempBattleStatName(this.tempBattleStat)
    });
  }
...
export class AttackTypeBoosterModifierType
  ...
  constructor(moveType: Type, boostPercent: integer) {
    super(
      ...
      (_type, args) =>
        new Modifiers.AttackTypeBoosterModifier(
          this,
  ...
  get name(): string {
    return i18next.t(
      `modifierType:AttackTypeBoosterItem.${getAttackTypeBoosterItemName(this.moveType).replace(/[ \-]/g, "_").toLowerCase()}`
    );
  }
...
export class PokemonLevelIncrementModifierType extends PokemonModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonLevelIncrementModifier(this, (args[0] as PlayerPokemon).id),
...
export class AllPokemonLevelIncrementModifierType extends ModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      localeKey,
      iconImage,
      (_type, _args) => new Modifiers.PokemonLevelIncrementModifier(this, -1)
    );
  }
...
export class PokemonBaseStatBoosterModifierType
  ...
  constructor(localeName: string, stat: Stat) {
    super(
      "",
      localeName.replace(/[ \-]/g, "_").toLowerCase(),
      (_type, args) =>
        new Modifiers.PokemonBaseStatModifier(this, (args[0] as Pokemon).id, this.stat)
    );
  ...
  get name(): string {
    return i18next.t(
      `modifierType:BaseStatBoosterItem.${this.localeName.replace(/[ \-]/g, "_").toLowerCase()}`
    );
  }

  getDescription(scene: BattleScene): string {
    return i18next.t("modifierType:ModifierType.PokemonBaseStatBoosterModifierType.description", {
      statName: getStatName(this.stat)
    });
  }
...
class AllPokemonFullHpRestoreModifierType extends ModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      newModifierFunc ||
        ((_type, _args) => new Modifiers.PokemonHpRestoreModifier(this, -1, 0, 100, false))
    );
...
export class MoneyRewardModifierType extends ModifierType {
  ...
  constructor(
    ...
    super(
      localeKey,
      iconImage,
      (_type, _args) => new Modifiers.MoneyRewardModifier(this, moneyMultiplier),
      "money",
      "buy"
    );
...
export class PokemonExpBoosterModifierType extends PokemonHeldItemModifierType {
  ...
  constructor(localeKey: string, iconImage: string, boostPercent: integer) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonExpBoosterModifier(this, (args[0] as Pokemon).id, boostPercent)
    );
...
export class PokemonFriendshipBoosterModifierType extends PokemonHeldItemModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonFriendshipBoosterModifier(this, (args[0] as Pokemon).id)
    );
  }
...
export class PokemonMoveAccuracyBoosterModifierType extends PokemonHeldItemModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.PokemonMoveAccuracyBoosterModifier(this, (args[0] as Pokemon).id, amount),
      group,
      soundName
    );
...
export class PokemonMultiHitModifierType extends PokemonHeldItemModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (type, args) =>
        new Modifiers.PokemonMultiHitModifier(
...
export class TmModifierType extends PokemonModifierType {
  ...
  constructor(moveId: Moves) {
    super(
      ...
      (_type, args) => new Modifiers.TmModifier(this, (args[0] as PlayerPokemon).id),
      (pokemon: PlayerPokemon) => {
        if (
...
export class EvolutionItemModifierType
  ...
  constructor(evolutionItem: EvolutionItem) {
    super(
      ...
      (_type, args) => new Modifiers.EvolutionItemModifier(this, (args[0] as PlayerPokemon).id),
      (pokemon: PlayerPokemon) => {
        if (
          pokemonEvolutions.hasOwnProperty(pokemon.species.speciesId) &&
          pokemonEvolutions[pokemon.species.speciesId].filter(
            (e) =>
              e.item === this.evolutionItem && (!e.condition || e.condition.predicate(pokemon))
          ).length &&
...
export class FormChangeItemModifierType
  ...
  constructor(formChangeItem: FormChangeItem) {
    super(
      ...
      (_type, args) =>
        new Modifiers.PokemonFormChangeItemModifier(
          this,
          (args[0] as PlayerPokemon).id,
          formChangeItem,
          true
      ...
      (pokemon: PlayerPokemon) => {
        ...
        if (
          ...
          pokemonFormChanges[pokemon.species.speciesId]
            ...
            .map(
              (fc) => fc.findTrigger(SpeciesFormChangeItemTrigger) as SpeciesFormChangeItemTrigger
            )
            .flat()
            .flatMap((fc) => fc.item)
...
export class FusePokemonModifierType extends PokemonModifierType {
  constructor(localeKey: string, iconImage: string) {
    super(
      ...
      iconImage,
      (_type, args) =>
        new Modifiers.FusePokemonModifier(
          this,
          (args[0] as PlayerPokemon).id,
  ...
  constructor(rare: boolean) {
    super((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      const evolutionItemPool = [
        party
          .filter((p) => pokemonEvolutions.hasOwnProperty(p.species.speciesId))
          .map((p) => {
        ...
        party
          .filter(
            (p) => p.isFusion() && pokemonEvolutions.hasOwnProperty(p.fusionSpecies.speciesId)
          )
          .map((p) => {
      ...
      return new EvolutionItemModifierType(
        evolutionItemPool[Utils.randSeedInt(evolutionItemPool.length)]
      );
    });
  }
}
...
class FormChangeItemModifierTypeGenerator extends ModifierTypeGenerator {
  constructor() {
    super((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      const formChangeItemPool = party
            ...
            .filter(
              (fc) =>
                ((fc.formKey.indexOf(SpeciesFormKey.MEGA) === -1 &&
                  ...
                  party[0].scene.getModifiers(Modifiers.MegaEvolutionAccessModifier).length) &&
                ((fc.formKey.indexOf(SpeciesFormKey.GIGANTAMAX) === -1 &&
                  fc.formKey.indexOf(SpeciesFormKey.ETERNAMAX) === -1) ||
                  party[0].scene.getModifiers(Modifiers.GigantamaxAccessModifier).length)
            )
            .map(
              (fc) => fc.findTrigger(SpeciesFormChangeItemTrigger) as SpeciesFormChangeItemTrigger
            )
      ...
      return new FormChangeItemModifierType(
        formChangeItemPool[Utils.randSeedInt(formChangeItemPool.length)]
      );
    });
  }
}
...
export class TerastallizeModifierType
  ...
  constructor(teraType: Type) {
    super(
      ...
      (type, args) =>
        new Modifiers.TerastallizeModifier(
...
export class ContactHeldItemTransferChanceModifierType extends PokemonHeldItemModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      (type, args) =>
        new Modifiers.ContactHeldItemTransferChanceModifier(
          type,
          (args[0] as Pokemon).id,
          chancePercent
        ),
...
export class TurnHeldItemTransferModifierType extends PokemonHeldItemModifierType {
  constructor(localeKey: string, iconImage: string, group?: string, soundName?: string) {
    super(
      localeKey,
      iconImage,
      (type, args) => new Modifiers.TurnHeldItemTransferModifier(type, (args[0] as Pokemon).id),
      group,
      soundName
    );
  }
...
export class EnemyAttackStatusEffectChanceModifierType extends ModifierType {
  ...
  constructor(
    ...
    super(
      ...
      iconImage,
      (type, args) =>
        new Modifiers.EnemyAttackStatusEffectChanceModifier(
          type,
          effect,
          chancePercent,
          stackCount
...
export class EnemyEndureChanceModifierType extends ModifierType {
  ...
  constructor(localeKey: string, iconImage: string, chancePercent: number) {
    super(
      localeKey,
      iconImage,
      (type, _args) => new Modifiers.EnemyEndureChanceModifier(type, chancePercent),
      "enemy_endure"
    );
...
export const modifierTypes = {
  ...
  MEGA_BRACELET: () =>
    new ModifierType(
      ...
      "mega_bracelet",
      (type, _args) => new Modifiers.MegaEvolutionAccessModifier(type)
    ),
  DYNAMAX_BAND: () =>
    new ModifierType(
      "modifierType:ModifierType.DYNAMAX_BAND",
      "dynamax_band",
      (type, _args) => new Modifiers.GigantamaxAccessModifier(type)
    ),
  TERA_ORB: () =>
    new ModifierType(
      "modifierType:ModifierType.TERA_ORB",
      "tera_orb",
      (type, _args) => new Modifiers.TerastallizeAccessModifier(type)
    ),
  ...
  MAP: () =>
    new ModifierType(
      ...
      "map",
      (type, _args) => new Modifiers.MapModifier(type)
    ),

  POTION: () =>
    new PokemonHpRestoreModifierType("modifierType:ModifierType.POTION", "potion", 20, 10),
  SUPER_POTION: () =>
  ...
  FULL_HEAL: () =>
    new PokemonStatusHealModifierType("modifierType:ModifierType.FULL_HEAL", "full_heal"),
  ...
  LURE: () =>
    new DoubleBattleChanceBoosterModifierType("modifierType:ModifierType.LURE", "lure", 5),
  SUPER_LURE: () =>
  ...
  MAX_LURE: () =>
    new DoubleBattleChanceBoosterModifierType("modifierType:ModifierType.MAX_LURE", "max_lure", 25),
  ...
  MINT: () =>
    new ModifierTypeGenerator((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      return new PokemonNatureChangeModifierType(
        Utils.randSeedInt(Object.values(Nature).length) as Nature
      );
    }),
  ...
  BERRY: () =>
    new ModifierTypeGenerator((party: Pokemon[], pregenArgs?: any[]) => {
      ...
      const berryTypes = Object.values(BerryType);
  ...
  EXP_CHARM: () =>
    new ExpBoosterModifierType("modifierType:ModifierType.EXP_CHARM", "exp_charm", 25),
  SUPER_EXP_CHARM: () =>
  ...
  SOUL_DEW: () =>
    new PokemonHeldItemModifierType(
      ...
      "soul_dew",
      (type, args) => new Modifiers.PokemonNatureWeightModifier(type, (args[0] as Pokemon).id)
    ),
  ...
  AMULET_COIN: () =>
    new ModifierType(
      ...
      "amulet_coin",
      (type, _args) => new Modifiers.MoneyMultiplierModifier(type)
    ),
  GOLDEN_PUNCH: () =>
    new PokemonHeldItemModifierType(
      "modifierType:ModifierType.GOLDEN_PUNCH",
      "golden_punch",
      (type, args) => new Modifiers.DamageMoneyRewardModifier(type, (args[0] as Pokemon).id)
    ),
  COIN_CASE: () =>
    new ModifierType(
      "modifierType:ModifierType.COIN_CASE",
      "coin_case",
      (type, _args) => new Modifiers.MoneyInterestModifier(type)
    ),
  ...
  LOCK_CAPSULE: () =>
    new ModifierType(
      ...
      "lock_capsule",
      (type, _args) => new Modifiers.LockModifierTiersModifier(type)
    ),
  ...
  MULTI_LENS: () =>
    new PokemonMultiHitModifierType("modifierType:ModifierType.MULTI_LENS", "zoom_lens"),

  HEALING_CHARM: () =>
    new ModifierType(
      "modifierType:ModifierType.HEALING_CHARM",
      "healing_charm",
      (type, _args) => new Modifiers.HealingBoosterModifier(type, 1.1)
    ),
  CANDY_JAR: () =>
    new ModifierType(
      "modifierType:ModifierType.CANDY_JAR",
      "candy_jar",
      (type, _args) => new Modifiers.LevelIncrementBoosterModifier(type)
    ),
  ...
  TOXIC_ORB: () =>
    new PokemonHeldItemModifierType(
      ...
      "toxic_orb",
      (type, args) => new Modifiers.TurnStatusEffectModifier(type, (args[0] as Pokemon).id)
    ),
  FLAME_ORB: () =>
    new PokemonHeldItemModifierType(
  ...
  BATON: () =>
    new PokemonHeldItemModifierType(
      ...
      "stick",
      (type, args) => new Modifiers.SwitchEffectTransferModifier(type, (args[0] as Pokemon).id)
    ),
  ...
  SHINY_CHARM: () =>
    new ModifierType(
      ...
      "shiny_charm",
      (type, _args) => new Modifiers.ShinyRateBoosterModifier(type)
    ),
  ABILITY_CHARM: () =>
    new ModifierType(
      "modifierType:ModifierType.ABILITY_CHARM",
      "ability_charm",
      (type, _args) => new Modifiers.HiddenAbilityRateBoosterModifier(type)
    ),
  ...
  IV_SCANNER: () =>
    new ModifierType(
      ...
      "scanner",
      (type, _args) => new Modifiers.IvScannerModifier(type)
    ),
  ...
  GOLDEN_POKEBALL: () =>
    new ModifierType(
      ...
      "pb_gold",
      (type, _args) => new Modifiers.ExtraModifierModifier(type),
      null,
      "pb_bounce_1"
    ),
  ...
  ENEMY_DAMAGE_REDUCTION: () =>
    new ModifierType(
      ...
      "wl_guard_spec",
      (type, _args) => new Modifiers.EnemyDamageReducerModifier(type, 2.5)
    ),
  ...
  ENEMY_HEAL: () =>
    new ModifierType(
      ...
      "wl_potion",
      (type, _args) => new Modifiers.EnemyTurnHealModifier(type, 2, 10)
    ),
  ...
  ENEMY_STATUS_EFFECT_HEAL_CHANCE: () =>
    new ModifierType(
      ...
      "wl_full_heal",
      (type, _args) => new Modifiers.EnemyStatusEffectHealChanceModifier(type, 2.5, 10)
    ),
  ENEMY_ENDURE_CHANCE: () =>
  ...
  ENEMY_FUSED_CHANCE: () =>
    new ModifierType(
      ...
      "wl_custom_spliced",
      (type, _args) => new Modifiers.EnemyFusionChanceModifier(type, 1)
    )
};

type ModifierPool = Record<string, WeightedModifierType[]>;
...
const modifierPool: ModifierPool = {
  [ModifierTier.COMMON]: [
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        const thresholdPartyMemberCount = Math.min(
          party.filter((p) => (p.getInverseHp() >= 10 || p.getHpRatio() <= 0.875) && !p.isFainted())
            .length,
          3
        );
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        const thresholdPartyMemberCount = Math.min(
          party.filter((p) => (p.getInverseHp() >= 25 || p.getHpRatio() <= 0.75) && !p.isFainted())
            .length,
          3
        );
      ...
      (party: Pokemon[]) => {
        const thresholdPartyMemberCount = Math.min(
          party.filter(
            (p) =>
              p.hp &&
              p.getMoveset().filter((m) => m.ppUsed && m.getMovePp() - m.ppUsed <= 5).length
          ).length,
          3
        );
        return thresholdPartyMemberCount * 3;
  ...
  [ModifierTier.GREAT]: [
            ...
            (p) =>
              ...
              !p.getHeldItems().some((i) => {
                if (i instanceof Modifiers.TurnStatusEffectModifier) {
                  return i.getStatusEffect() === p.status.effect;
                }
                return false;
              })
          ).length,
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        const thresholdPartyMemberCount = Math.min(
          party.filter(
            (p) => (p.getInverseHp() >= 100 || p.getHpRatio() <= 0.625) && !p.isFainted()
          ).length,
          3
        );
        return thresholdPartyMemberCount * 3;
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        const thresholdPartyMemberCount = Math.min(
          party.filter((p) => (p.getInverseHp() >= 150 || p.getHpRatio() <= 0.5) && !p.isFainted())
            .length,
          3
        );
        return thresholdPartyMemberCount;
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => {
        ...
        const thresholdPartyMemberCount = Math.floor(
          (Math.min(
            party.filter(
              (p) => (p.getInverseHp() >= 150 || p.getHpRatio() <= 0.5) && !p.isFainted()
            ).length,
            3
          ) +
    ...
    new WeightedModifierType(
      modifierTypes.MAP,
      (party: Pokemon[]) =>
        party[0].scene.gameMode.isClassic && party[0].scene.currentBattle.waveIndex < 180 ? 1 : 0,
      1
    ),
    ...
    new WeightedModifierType(modifierTypes.DNA_SPLICERS, (party: Pokemon[]) =>
      party[0].scene.gameMode.isSplicedOnly && party.filter((p) => !p.fusionSpecies).length > 1
        ? 4
        : 0
    ),
    new WeightedModifierType(
      ...
      (party: Pokemon[], rerollCount: integer) =>
        !party[0].scene.gameMode.isDaily ? Math.max(1 - rerollCount, 0) : 0,
      1
    )
  ].map((m) => {
  ...
  [ModifierTier.ULTRA]: [
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) =>
        Math.min(Math.ceil(party[0].scene.currentBattle.waveIndex / 15) * 4, 32),
      32
    ),
        ...
        return party.some(
          (p) =>
            ...
            (checkedAbilities.some((a) => p.hasAbility(a, false, true)) ||
              p.getMoveset(true).some((m) => checkedMoves.includes(m.moveId)))
        )
          ? 10
          : 0;
      },
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) =>
        Math.min(Math.max(Math.floor(party[0].scene.currentBattle.waveIndex / 50) * 2, 1), 4),
      4
    ),
  ...
  [ModifierTier.ROGUE]: [
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => Math.min(Math.ceil(party[0].scene.currentBattle.waveIndex / 50), 4) * 8,
      32
    ),
    new WeightedModifierType(
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[], rerollCount: integer) =>
        !party[0].scene.gameMode.isDaily ? Math.max(5 - rerollCount * 2, 0) : 0,
      5
    )
  ].map((m) => {
  ...
  [ModifierTier.MASTER]: [
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[], rerollCount: integer) =>
        ...
        !party[0].scene.gameMode.isEndless &&
        !party[0].scene.gameMode.isSplicedOnly
          ? Math.max(6 - rerollCount * 2, 0)
          : 0,
      6
    ),
    new WeightedModifierType(
    ...
    new WeightedModifierType(
      ...
      (party: Pokemon[]) => (party[0].scene.gameData.unlocks[Unlockables.MINI_BLACK_HOLE] ? 1 : 0),
      1
    )
  ].map((m) => {
...
const wildModifierPool: ModifierPool = {
  ...
  [ModifierTier.ULTRA]: [new WeightedModifierType(modifierTypes.ATTACK_TYPE_BOOSTER, 10)].map(
    (m) => {
      m.setTier(ModifierTier.ULTRA);
      return m;
    }
...
const trainerModifierPool: ModifierPool = {
  ...
  [ModifierTier.ULTRA]: [new WeightedModifierType(modifierTypes.ATTACK_TYPE_BOOSTER, 1)].map(
    (m) => {
      m.setTier(ModifierTier.ULTRA);
      return m;
    }
...
const dailyStarterModifierPool: ModifierPool = {
  ...
  [ModifierTier.GREAT]: [new WeightedModifierType(modifierTypes.ATTACK_TYPE_BOOSTER, 5)].map(
    (m) => {
      m.setTier(ModifierTier.GREAT);
      return m;
    }
...
export function regenerateModifierPoolThresholds(
      ...
      Object.keys(pool).map((t) => {
        ...
        pool[t].reduce((total: integer, modifierType: WeightedModifierType) => {
          ...
          const existingModifiers = party[0].scene.findModifiers(
            (m) => (m.type.generatorId || m.type.id) === weightedModifierType.modifierType.id,
          ...
          if (weightedModifierType.maxWeight) {
            const modifierId =
              weightedModifierType.modifierType.generatorId || weightedModifierType.modifierType.id;
        ...
        for (const id of tierModifierIds) {
          modifierTableData[id].tierPercent =
            Math.floor((modifierTableData[id].weight / tierMaxWeight) * 10000) / 100;
        }
  ...
  for (const id of Object.keys(modifierTableData)) {
    modifierTableData[id].totalPercent =
      Math.floor(
        modifierTableData[id].tierPercent * tierWeights[modifierTableData[id].tier] * 100
      ) / 100;
...
export function getPlayerModifierTypeOptions(
  ...
  new Array(count).fill(0).map((_, i) => {
    let candidate = getNewModifierTypeOption(
      ...
      modifierTiers?.length > i ? modifierTiers[i] : undefined
    );
    let r = 0;
    while (
      options.length &&
  ...
  if (Overrides.ITEM_REWARD_OVERRIDE.length) {
    options.forEach((mod, i) => {
      ...
      mod.type =
        (override instanceof ModifierTypeGenerator ? override.generateType(party) : override) ||
        mod.type;
    });
  }
  return options;
...
export function getEnemyBuffModifierForWave(
  ...
  while (
    ...
    matchingModifier.getMaxStackCount(scene) <
    ...
    .map(
      () =>
        getNewModifierTypeOption(
          ...
          poolType,
          undefined,
          upgradeChance && !Utils.randSeedInt(upgradeChance) ? 1 : 0
  ...
  for (const p of party) {
    for (let m = 0; m < 3; m++) {
      ...
      const modifier = getNewModifierTypeOption(
        ...
        tier
      ).type.newModifier(p) as Modifiers.PokemonHeldItemModifier;
      ret.push(modifier);
    }
  }
...
export function getLuckString(luckValue: integer): string {
  return ["D", "C", "C+", "B-", "B", "B+", "A-", "A", "A+", "A++", "S", "S+", "SS", "SS+", "SSS"][
    luckValue
  ];
}

export function getLuckTextTint(luckValue: integer): integer {
  const modifierTier = luckValue
    ? luckValue > 2
      ? luckValue > 5
        ? luckValue > 9
          ? luckValue > 11
