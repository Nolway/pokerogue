...
type PokemonEvolutions = Record<string, SpeciesFormEvolution[]>;
...
export const pokemonEvolutions: PokemonEvolutions = {
  ...
  [Species.SLOWPOKE]: [
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition((p) => true /* King's Rock */),
  ...
  [Species.CUBONE]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) => p.scene.arena.biomeType === Biome.ISLAND || p.scene.arena.biomeType === Biome.BEACH
      ),
  ...
  [Species.TYROGUE]: [
    new SpeciesEvolution(
      ...
      20,
      null,
      new SpeciesEvolutionCondition((p) => p.stats[Stat.ATK] > p.stats[Stat.DEF])
    ),
    new SpeciesEvolution(
      Species.HITMONCHAN,
      20,
  ...
  [Species.KOFFING]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.arena.biomeType === Biome.METROPOLIS || p.scene.arena.biomeType === Biome.SLUM
      ),
      SpeciesWildEvolutionDelay.MEDIUM
    ),
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          ...
          p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT
      ),
    ...
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          ...
          p.scene.arena.getTimeOfDay() === TimeOfDay.DAY
      )
    )
  ],
  ...
  [Species.NINCADA]: [
    ...
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.scene.getParty().length < 6 && p.scene.pokeballCounts[PokeballType.POKEBALL] > 0
      )
    )
  ],
  ...
  [Species.BISHARP]: [new SpeciesEvolution(Species.KINGAMBIT, 64, null, null)],
  [Species.RUFFLET]: [
    new SpeciesEvolution(
  ...
  [Species.PANCHAM]: [
    new SpeciesEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          !!p.scene.getParty().find((p) => p.getTypes(false, false, true).indexOf(Type.DARK) > -1)
      ),
      SpeciesWildEvolutionDelay.MEDIUM
    )
  ],
  ...
  [Species.TYRUNT]: [
    new SpeciesEvolution(
      ...
      39,
      null,
      new SpeciesEvolutionCondition((p) => p.scene.arena.getTimeOfDay() === TimeOfDay.DAY),
      SpeciesWildEvolutionDelay.MEDIUM
    )
  ],
  [Species.AMAURA]: [
    new SpeciesEvolution(
      ...
      39,
      null,
      new SpeciesEvolutionCondition((p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT),
      SpeciesWildEvolutionDelay.MEDIUM
    )
  ],
  [Species.GOOMY]: [
  ...
  [Species.TANDEMAUS]: [new SpeciesEvolution(Species.MAUSHOLD, 25, null, null)],
  ...
  [Species.TANGELA]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.ANCIENT_POWER).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.LICKITUNG]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.ROLLOUT).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  ...
  [Species.EEVEE]: [
    ...
    new SpeciesFormEvolution(
      ...
      new SpeciesFriendshipEvolutionCondition(
        70,
        (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.DAY
      ),
      SpeciesWildEvolutionDelay.LONG
    ),
    new SpeciesFormEvolution(
    ...
    new SpeciesFormEvolution(
      ...
      new SpeciesFriendshipEvolutionCondition(
        70,
        (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT
      ),
      SpeciesWildEvolutionDelay.LONG
    ),
    new SpeciesFormEvolution(
  ...
  [Species.AIPOM]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.DOUBLE_HIT).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  ...
  [Species.GIRAFARIG]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.TWIN_BEAM).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.DUNSPARCE]: [
    ...
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.HYPER_DRILL).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.GLIGAR]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT /* Razor fang at night*/
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.SNEASEL]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.NIGHT /* Razor claw at night*/
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  ...
  [Species.STANTLER]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.PSYSHIELD_BASH).length > 0
      ),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  ...
  [Species.BONSLY]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.MIMIC).length > 0
      ),
      SpeciesWildEvolutionDelay.MEDIUM
    )
  ],
  ...
  [Species.STEENEE]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.STOMP).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.POIPOLE]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.DRAGON_PULSE).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  ...
  [Species.MILCERY]: [
    ...
    new SpeciesFormEvolution(
      ...
      new SpeciesEvolutionCondition(
        (p) =>
          p.scene.arena.biomeType === Biome.WASTELAND ||
          p.scene.arena.biomeType === Biome.LABORATORY
      ),
      SpeciesWildEvolutionDelay.LONG
    ),
    new SpeciesFormEvolution(
  ...
  [Species.HISUI_QWILFISH]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.BARB_BARRAGE).length > 0
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.HISUI_SNEASEL]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.scene.arena.getTimeOfDay() === TimeOfDay.DAY /* Razor claw at day*/
      ),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  ...
  [Species.DIPPLIN]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.DRAGON_CHEER).length > 0
      ),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  ...
  [Species.RHYDON]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Protector */),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.SEADRA]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Dragon scale*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.SCYTHER]: [
  ...
  [Species.ELECTABUZZ]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Electirizer*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.MAGMAR]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Magmarizer*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.PORYGON]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /*Upgrade*/),
      SpeciesWildEvolutionDelay.LONG
    )
  ],
  [Species.PORYGON2]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Dubious disc*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.FEEBAS]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Prism scale*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.DUSCLOPS]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /* Reaper cloth*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.CLAMPERL]: [
  ...
  [Species.SHELMET]: [
    new SpeciesEvolution(
      ...
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition(
        (p) => !!p.scene.gameData.dexData[Species.KARRABLAST].caughtAttr
      ),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.SPRITZEE]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /*Sachet*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.SWIRLIX]: [
    new SpeciesEvolution(
      ...
      1,
      EvolutionItem.LINKING_CORD,
      new SpeciesEvolutionCondition((p) => true /*Whipped Dream*/),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.PHANTUMP]: [
  ...
  [Species.PRIMEAPE]: [
    new SpeciesEvolution(
      ...
      null,
      new SpeciesEvolutionCondition(
        (p) => p.moveset.filter((m) => m.moveId === Moves.RAGE_FIST).length > 0
      ),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.GOLBAT]: [
    new SpeciesEvolution(
      ...
      1,
      null,
      new SpeciesFriendshipEvolutionCondition(110),
      SpeciesWildEvolutionDelay.VERY_LONG
    )
  ],
  [Species.CHANSEY]: [
...
type PokemonPrevolutions = Record<string, Species>;
