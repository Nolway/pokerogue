...
export type TrainerTierPools = Record<integer, Species[]>;
...
export type PartyMemberFuncs = Record<integer, PartyMemberFunc>;
...
export class TrainerConfig {
  ...
  initForEliteFour(
    ...
    this.setVictoryBgm("victory_gym");
    this.setGenModifiersFunc((party) =>
      getRandomTeraModifiers(party, 2, specialtyTypes.length ? specialtyTypes : null)
    );
...
type TrainerConfigs = Record<integer, TrainerConfig>;
...
function getRandomTeraModifiers(
  ...
  for (let t = 0; t < Math.min(count, party.length); t++) {
    ...
    ret.push(
      modifierTypes
        .TERA_SHARD()
        .generateType(null, [Utils.randSeedItem(types ? types : party[randomIndex].getTypes())])
...
export const signatureSpecies: SignatureSpecies = {
  ...
  BRUNO: [
    ...
    Species.HITMONCHAN,
    Species.HITMONLEE,
    [Species.ALOLA_GOLEM, Species.GOLEM]
  ],
  ...
  KOGA: [
    [Species.WEEZING, Species.MUK],
    [Species.VENOMOTH, Species.ARIADOS],
    Species.CROBAT,
    Species.TENTACRUEL
  ],
  ...
  PHOEBE: [
    ...
    Species.DUSKNOIR,
    Species.BANETTE,
    [Species.MISMAGIUS, Species.DRIFBLIM]
  ],
  ...
  AARON: [
    [Species.SCIZOR, Species.KLEAVOR],
    Species.HERACROSS,
    [Species.VESPIQUEN, Species.YANMEGA],
    Species.DRAPION
  ],
  ...
  HALA: [
    ...
    [Species.POLIWRATH, Species.ANNIHILAPE]
  ],
  ...
  ACEROLA: [
    [Species.BANETTE, Species.DRIFBLIM],
    Species.MIMIKYU,
    Species.DHELMISE,
    Species.PALOSSAND
  ],
  KAHILI: [
    [Species.BRAVIARY, Species.MANDIBUZZ],
    Species.HAWLUCHA,
    Species.ORICORIO,
    Species.TOUCANNON
  ],
  MARNIE_ELITE: [
    Species.MORPEKO,
    Species.LIEPARD,
    [Species.TOXICROAK, Species.SCRAFTY],
    Species.GRIMMSNARL
  ],
  NESSA_ELITE: [
    Species.GOLISOPOD,
    [Species.PELIPPER, Species.QUAGSIRE],
    Species.TOXAPEX,
    Species.DREDNAW
  ],
  BEA_ELITE: [
    Species.HAWLUCHA,
    [Species.GRAPPLOCT, Species.SIRFETCHD],
    Species.FALINKS,
    Species.MACHAMP
  ],
  ALLISTER_ELITE: [
    Species.DUSKNOIR,
    [Species.POLTEAGEIST, Species.RUNERIGUS],
    Species.CURSOLA,
    Species.GENGAR
  ],
  RAIHAN_ELITE: [
    Species.GOODRA,
    [Species.TORKOAL, Species.TURTONATOR],
    Species.FLYGON,
    Species.ARCHALUDON
  ],
  ...
  HASSEL: [
    Species.NOIVERN,
    [Species.FLAPPLE, Species.APPLETUN],
    Species.DRAGALGE,
    Species.BAXCALIBUR
  ],
  ...
  LACEY: [
    Species.EXCADRILL,
    Species.PRIMARINA,
    [Species.ALCREMIE, Species.GRANBULL],
    Species.WHIMSICOTT
  ],
  ...
  ALDER: [
    Species.VOLCARONA,
    Species.ZEKROM,
    [Species.ACCELGOR, Species.ESCAVALIER],
    Species.KELDEO
  ], // Bouffalant/Braviary lead
...
export const trainerConfigs: TrainerConfigs = {
  ...
  [TrainerType.FIREBREATHER]: new TrainerConfig(++t)
    ...
    .setEncounterBgm(TrainerType.ROUGHNECK)
    .setSpeciesFilter(
      (s) => !!s.getLevelMoves().find((plm) => plm[1] === Moves.SMOG) || s.isOfType(Type.FIRE)
    ),
  ...
  [TrainerType.STEVEN]: new TrainerConfig(++t)
    ...
    .setMixedBattleBgm("battle_hoenn_champion")
  ...
  [TrainerType.ALDER]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.BOUFFALANT, Species.BRAVIARY],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.generateAndPopulateMoveset();
  ...
  [TrainerType.KIERAN]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.POLIWRATH, Species.POLITOED],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.generateAndPopulateMoveset();
  ...
  [TrainerType.ROCKET_BOSS_GIOVANNI_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.TYRANITAR, Species.IRON_THORNS],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
  ...
  [TrainerType.MAXIE_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.SOLROCK, Species.HOUNDOOM],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
    ...
    .setPartyMemberFunc(
      2,
      getRandomPartyMemberFunc(
        [Species.SHIFTRY, Species.SCOVILLAIN],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.generateAndPopulateMoveset();
  ...
  [TrainerType.ARCHIE_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.KINGDRA, Species.LUDICOLO],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
    ...
    .setPartyMemberFunc(
      1,
      getRandomPartyMemberFunc(
        [Species.BEARTIC, Species.ARMALDO],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.generateAndPopulateMoveset();
    ...
    .setPartyMemberFunc(
      2,
      getRandomPartyMemberFunc(
        [Species.HUNTAIL, Species.GOREBYSS],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.generateAndPopulateMoveset();
    ...
    .setPartyMemberFunc(
      3,
      getRandomPartyMemberFunc(
        [Species.POLITOED, Species.PELIPPER],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.generateAndPopulateMoveset();
  ...
  [TrainerType.CYRUS_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.AZELF, Species.UXIE, Species.MESPRIT],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
  ...
  [TrainerType.GHETSIS_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.SLITHER_WING, Species.IRON_MOTH],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
    ...
    .setPartyMemberFunc(
      5,
      getRandomPartyMemberFunc(
        [Species.HYDREIGON, Species.IRON_JUGULIS],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
  ...
  [TrainerType.LYSANDRE_2]: new TrainerConfig(++t)
    ...
    .setPartyMemberFunc(
      0,
      getRandomPartyMemberFunc(
        [Species.SCREAM_TAIL, Species.FLUTTER_MANE],
        TrainerSlot.TRAINER,
        true,
        (p) => {
          p.setBoss(true, 2);
