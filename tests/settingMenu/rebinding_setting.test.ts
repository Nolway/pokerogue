...
import { MenuManip } from "./helpers/menuManip";
import { InGameManip } from "./helpers/inGameManip";
...
describe("Test Rebinding", () => {
  ...
  const configs = new Map<string, InterfaceConfig>();
  ...
  beforeEach(() => {
    config = { ...cfg_keyboard_qwerty } satisfies typeof cfg_keyboard_qwerty;
  ...
  it("Swap alt with a main", () => {
    ...
    inTheSettingMenu
      .whenCursorIsOnSetting("Cycle_Shiny")
